...
not entire frames */
int KstFile::readField(double *V, const char *field, int s, int n){
...
int KstFile::determineType(){
  ...
  NumFrames = GetNFrames(lfilename, &error_code);
...
int KstFile::asciiReadField(double *V, const char *field, int s, int n){
  int i_row, i_char, i;
  char *tmpbuf;
  int bufread;
  int bufstart, col;
...
int KstFile::frameReadField(double *V, const char *field, int s, int n){
  int error_code;
  int n_read;
  char tmpstr[128];
...
bool KstFile::dirfileUpdate(){
  ...
  newNF = GetNFrames(Filename, &error_code);
...
read just one sample, not an entire frame.  The number
of samples read is returned */
int KstFile::dirfileReadField(double *V, const char *field, int s, int n){
  int error_code;
  int n_read;
  char tmpstr[17];
