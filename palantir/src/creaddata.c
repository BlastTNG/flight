 ...
 * ----------- ----------        -------
 * ??-???-1996 CB Netterfield    Started CalSpecs
 *
 * 05-Mar-1999 K. Ganga          Made CalSpecs directory a define, so can be
 *                               defined at compile time.
 *
 * 24-Aug-2000 CB Netterifield   Modified to return error request for FILEFRAM
 *                               on unknown file type
 */
#include <stdio.h>
#include <malloc.h>
#include <stdlib.h>
