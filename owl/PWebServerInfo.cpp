...
#include "ui_PWebServerInfo.h"

PWebServerInfo::PWebServerInfo(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::PWebServerInfo)
{
    ui->setupUi(this);
    setWindowTitle("Web Server Help");
}

PWebServerInfo::~PWebServerInfo()
{
    delete ui;
}
