...
const char *command_list_serial = "$Revision: 3.22 $";
...
struct scom scommands[N_SCOMMANDS] = {
  ...
  {COMMAND(actbus_on), "turn on the Actuators and Lock", GR_POWER},
  {COMMAND(actbus_off), "turn off the Actuators and Lock", GR_POWER | CONFIRM},
  ...
  {COMMAND(auto_cycle), "turn on the helium fridge autocylce", GR_CRYO_HEAT},
  {COMMAND(fridge_cycle),
    "manually force the helium three fridge to be cycled now", GR_CRYO_HEAT},
