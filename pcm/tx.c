...
static void WriteMCESlow(void)
{
  ...
  WriteData(dataModeBitsAddr,
      ((CommandData.data_mode_bits[CommandData.data_mode][1][0] & 0x1F) << 11) |
      ((CommandData.data_mode_bits[CommandData.data_mode][1][1] & 0x0F) <<  6) |
      (CommandData.data_mode_bits[CommandData.data_mode][0][0] & 0x1F),
      NIOS_QUEUE);
