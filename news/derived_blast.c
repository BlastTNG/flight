...
//  LINTERP("HE4_PERCENT", "HE4_LEV", "/data/etc/he4_percent.txt"),
  ...
  PHASE("X2G11V", "N21C23", 0),
  PHASE("X3A07V", "N27C00", 0),
  ...
  PHASE("X5C02H", "N31C16", 0),
  PHASE("X5B02H", "N31C17", 0),
