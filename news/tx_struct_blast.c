...
struct ChannelStruct SlowChannels[] = {
  ...
  {"t_mot_pump_val",'r', BIAS_T1,  15,  CAL16T(1.0,	    0.0), 'u', U_T_C},
  {"t_1_prime",    'r', BIAS_T1,  17, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_if_top_back",'r', BIAS_T1, 19, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_hwpr_mot",    'r', BIAS_T1, 21,  CAL16T(1.0,	    0.0), 'u', U_T_C},
  {"t_if_top_frnt",'r', BIAS_T1, 23, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_hwpr_feed",   'r', BIAS_T1, 25,  CAL16T(1.0,	    0.0), 'u', U_T_C},
  {"t_das",        'r', BIAS_T1, 7, CAL16T(1.0, 0.0),                    'u', U_T_C}, // THIS IS WRONG!
  {"t_if_bot_frnt",'r', BIAS_T1, 27, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_strut_bot",  'r', BIAS_T1, 29, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_strut_side", 'r', BIAS_T1, 31, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_2_prime",    'r', BIAS_T1, 33, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_if_bot_back",'r', BIAS_T1, 35, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_dac_box",     'r', BIAS_T1, 37,  CAL16T(1.0,      0.0), 'u', U_T_C},
  {"t_mot_act",    'r', BIAS_T1, 39, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_push_plate", 'r', BIAS_T1, 41, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_1_second",   'r', BIAS_T1, 43, CAL16T(1.0, 0.0),                    'u', U_T_C},
  {"t_2_second",   'r', BIAS_T1, 45, CAL16T(1.0, 0.0),                    'u', U_T_C},
