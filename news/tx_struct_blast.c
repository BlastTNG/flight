...
struct ChannelStruct SlowChList[N_SLOW][FAST_PER_SLOW] = {
  ...
  },
  {
    ...
    {"p_az_mode",   'r', LOOPBACK, 35,           1.0,             0.0, 'u'},
    {"p_az1",       'r', LOOPBACK, 36,           I2DEG,           0.0, 'u'},
    {"p_az2",       'r', LOOPBACK, 37,           I2DEG,           0.0, 'u'},
    {"p_el1",       'r', LOOPBACK, 38,           I2DEG,           0.0, 'u'},
    {"p_el2",       'r', LOOPBACK, 39,           I2DEG,           0.0, 'u'},
    {"p_az_vel",    'r', LOOPBACK, 40,           I2VEL,           0.0, 'u'},
    {"p_el_vel",    'r', LOOPBACK, 41,           I2VEL,           0.0, 'u'},
    {"p_ra",        'r', LOOPBACK, 46,           I2H,             0.0, 'u'},
    {"p_dec",       'r', LOOPBACK, 47,           I2DEG,           0.0, 'u'},
    {"p_r",         'r', LOOPBACK, 48,           I2DEG,           0.0, 'u'},
    {"p_el_mode",   'r', LOOPBACK, 49,           1.0,             0.0, 'u'},
