...
struct ChannelStruct SlowChList[N_SLOW][FAST_PER_SLOW] = {
  ...
  },
  {
    ...
    {"i_dpm_28v",    'r',  4, 23,          -0.000125,           4.096, 'u'},
    {"i_dpm_3v",     'r',  4, 25,          -0.000125,           4.096, 'u'},
    {"i_dpm_5v",     'r',  4, 27,          -0.000125,           4.096, 'u'},
    {"i_dpm_10v",    'r',  4, 29,          -0.000125,           4.096, 'u'},
    {"i_rec",        'r',  4, 31,          -0.000125,           4.096, 'u'},
  ...
  },
  {
    ...
    {"isc_expose",  'w', LOOPBAK2,  4,           1.0,             0.0, 'u'},
  ...
  },
  {
    ...
    {"isc_pscale",  'w', LOOPBAK2, 14,      1./1000.,             0.0, 'u'},
    {"isc_gain",    'w', LOOPBAK2, 15,           1.0,             0.0, 'u'},
  ...
  },
  {
    ...
    {"isc_offset",  'w', LOOPBAK2, 20,           1.0,             0.0, 'u'},
    {"isc_mapmean", 'w', LOOPBAK2, 21,         1./4.,             0.0, 'u'},
