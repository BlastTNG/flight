...
struct ChannelStruct SlowChList[N_SLOW][FAST_PER_SLOW] = {
  ...
  {
    {"i_charcoal",   'r', 3,  1, 1.0,     0.0,   'u'},
    {"i_he_lev",     'r', 3,  3, 1.0,     0.0,   'u'},
    {"i_jfet",       'r', 3,  5, 1.0,     0.0,   'u'},
    {"i_heatswitch", 'r', 3,  7, 1.0,     0.0,   'u'},
    {"i_he3",        'r', 3,  9, 1.0,     0.0,   'u'},
    {"t_vcs1",       'r', 3,  11, 1.0,    0.0,   'u'},
    {"t_vcs_fet",    'r', 3,  13, 1.0,    0.0,   'u'},
    {"t_he4",        'r', 3,  15, 1.0,    0.0,   'u'},
    {"t_ln2",        'r', 3,  17, 1.0,    0.0,   'u'},
    {"t_jfet",       'r', 3,  19, 1.0,    0.0,   'u'},
    {"t_mirror3",    'r', 3,  21, 1.0,    0.0,   'u'},
    {"t_mirror5",    'r', 3,  23, 1.0,    0.0,   'u'},
    {"t_lyot_stim",  'r', 3,  25, 1.0,    0.0,   'u'},
    {"t_heatswitch", 'r', 3,  27, 1.0,    0.0,   'u'},
    {"t_charcoal",   'r', 3,  29, 1.0,    0.0,   'u'},
    {"t_he4pot",     'r', 3,  31, 1.0,    0.0,   'u'},
    {"t_mirror4",    'r', 3,  33, 1.0,    0.0,   'u'},
    {"t_ln_filt",    'r', 3,  35, 1.0,    0.0,   'u'},
    {"t_ln_filt_vcs",'r', 3,  37, 1.0,    0.0,   'u'},
    {"t_he_filt",    'r', 3,  39, 1.0,    0.0,   'u'}
  },
  {
    {"t_he3",        'r',  3,  41, 1.0,             0.0,   'u'},
    {"t_bda1",       'r',  2,  43, 1.0,             0.0,   'u'},
    {"t_bda2",       'r',  3,  45, 1.0,             0.0,   'u'},
    {"t_bda3",       'r',  3,  47, 1.0,             0.0,   'u'},
    {"he4_level",    'r',  3,  49, 1.0,             0.0,   'u'},
  ...
  },
  {
    ...
    {"cryopwm1",      'w',  3,  3, 1.0,     0.0,   'u'},
    {"cryopwm2",      'w',  3,  4, 1.0,     0.0,   'u'},
    {"cryopwm3",      'w',  3,  5, 1.0,     0.0,   'u'},
    {"cryopwm4",      'w',  3,  6, 1.0,     0.0,   'u'},
    ...
    {"spare38",       'r', 18, 38, 1.0,     0.0,   'u'},
    {"spare39",       'r', 18, 39, 1.0,     0.0,   'u'},  
  },
  {
    ...
    {"spare43",       'r', 18, 43, 1.0,     0.0,   'u'},
    {"spare44",       'r', 18, 44, 1.0,     0.0,   'u'},
    {"spare45",       'r', 18, 45, 1.0,     0.0,   'u'},
    {"spare46",       'r', 18, 46, 1.0,     0.0,   'u'},
    {"spare47",       'r', 18, 47, 1.0,     0.0,   'u'},
    {"spare48",       'r', 18, 48, 1.0,     0.0,   'u'},
    {"spare49",       'r', 18, 49, 1.0,     0.0,   'u'},
    {"spare50",       'r', 18, 50, 1.0,     0.0,   'u'},
    {"spare51",       'r', 18, 51, 1.0,     0.0,   'u'},
    {"spare52",       'r', 18, 52, 1.0,     0.0,   'u'},
    {"spare53",       'r', 18, 53, 1.0,     0.0,   'u'},
    {"spare54",       'r', 18, 54, 1.0,     0.0,   'u'},
    {"spare55",       'r', 18, 55, 1.0,     0.0,   'u'},
    {"spare56",       'r', 18, 56, 1.0,     0.0,   'u'},
    {"spare57",       'r', 18, 57, 1.0,     0.0,   'u'},
    {"spare58",       'r', 18, 58, 1.0,     0.0,   'u'},
    {"spare59",       'r', 18, 59, 1.0,     0.0,   'u'},  
  }
};
...
struct ChannelStruct FastChList[N_FASTCHLIST] = {
  ...
  /* Read from DAS4 -- bias controller and DPM/inner frame monitoring */
    ...
    {"n5ref",    'r',  5, 36, 1.0,     0.0,   'U'},
    {"",         'r',  5, 37, 1.0,     0.0,   'u'},
    {"n6ref",    'r',  6, 36, 1.0,     0.0,   'U'},
    {"",         'r',  6, 37, 1.0,     0.0,   'u'},
    {"n7ref",    'r',  7, 36, 1.0,     0.0,   'U'},
    {"",         'r',  7, 37, 1.0,     0.0,   'u'},
    {"n8ref",    'r',  8, 36, 1.0,     0.0,   'U'},
    {"",         'r',  8, 37, 1.0,     0.0,   'u'},
    {"n9ref",    'r',  9, 36, 1.0,     0.0,   'U'},
    {"",         'r',  9, 37, 1.0,     0.0,   'u'},
    {"n10ref",   'r', 10, 36, 1.0,     0.0,   'U'},
    {"",         'r', 10, 37, 1.0,     0.0,   'u'},
    {"n11ref",   'r', 11, 36, 1.0,     0.0,   'U'},
    {"",         'r', 11, 37, 1.0,     0.0,   'u'},
    {"n12ref",   'r', 12, 36, 1.0,     0.0,   'U'},
    {"",         'r', 12, 37, 1.0,     0.0,   'u'},
    {"n13ref",   'r', 13, 36, 1.0,     0.0,   'U'},
    {"",         'r', 13, 37, 1.0,     0.0,   'u'},
    {"n14ref",   'r', 14, 36, 1.0,     0.0,   'U'},
    {"",         'r', 14, 37, 1.0,     0.0,   'u'},
    {"n15ref",   'r', 15, 36, 1.0,     0.0,   'U'},
    {"",         'r', 15, 37, 1.0,     0.0,   'u'},
    {"n16ref",   'r', 16, 36, 1.0,     0.0,   'U'},
    {"",         'r', 16, 37, 1.0,     0.0,   'u'},
...
void MakeTxFrame(void) {
  ...
  struct ChannelStruct channel = {"", 'r', 3, 0, 1.0, -2097152.0, 'u'};
