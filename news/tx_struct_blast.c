...
struct ChannelStruct SlowChList[N_SLOW][FAST_PER_SLOW] = {
  ...
  },
  {
    ...
    {"t_lhe",        'r',  3, 17, -2.86817e-09*65536,      12.2988073, 'u'},
    {"t_lhe_filt",   'r',  3, 19,  -2.8648e-09*65536,      12.2876163, 'u'},
    {"t_vcs",        'r',  3, 21, -2.87765e-09*65536,      12.3369079, 'u'},
    {"t_vcs_filt",   'r',  3, 23, -2.88013e-09*65536,      12.3447907, 'u'},
    {"t_ln2",        'r',  3, 25, -2.88055e-09*65536,      12.3452373, 'u'},
    {"t_ln2_filt",   'r',  3, 27, -2.88295e-09*65536,      12.3571711, 'u'},
    {"t_charcoal",   'r',  3, 29, -2.87356e-09*65536,      12.3273120, 'u'},
    {"t_heatswitch", 'r',  3, 31, -2.87221e-09*65536,      12.3169612, 'u'},
    {"t_jfet",       'r',  3, 33, -2.86827e-09*65536,      12.2987976, 'u'},
    {"t_vcs_fet",    'r',  3, 35, -1.91080320E-9*65536,    8.613594694, 'u'},
    {"t_xtherm_1",   'r',  3, 37, -4.01442351E-9*65536,    17.7211133, 'u'},
  ...
  },
  {
    ...
    {"he3pwm",       'w',  3,  3,        -100./2047.,            100., 'u'},
    {"jfetpwm",      'w',  3,  6,        -100./2047.,            100., 'u'},
