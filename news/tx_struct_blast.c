...
struct ChannelStruct WideSlowChannels[] = {
  ...
  {"td_hs_charcoal",'r', CRYO_A2, 24,           CRYO_D_M,        CRYO_D_B, 'U'},
  ...
  {"td_hs_pot",     'r', CRYO_A2, 44,           CRYO_D_M,        CRYO_D_B, 'U'},
...
struct ChannelStruct SlowChannels[] = {
  ...
  {"phase13",      'w', CRYO_A1,  8,                0.5,             0.0, 'u'},
  {"phase17",      'w', DAS1_A1,  8,                0.5,             0.0, 'u'},
  {"phase18",      'w', DAS1_A2,  8,                0.5,             0.0, 'u'},
  {"phase19",      'w', DAS1_A3,  8,                0.5,             0.0, 'u'},
  {"phase21",      'w', DAS2_A1,  8,                0.5,             0.0, 'u'},
  {"phase22",      'w', DAS2_A2,  8,                0.5,             0.0, 'u'},
  {"phase23",      'w', DAS2_A3,  8,                0.5,             0.0, 'u'},
  {"phase25",      'w', DAS3_A1,  8,                0.5,             0.0, 'u'},
  {"phase26",      'w', DAS3_A2,  8,                0.5,             0.0, 'u'},
  {"phase27",      'w', DAS3_A3,  8,                0.5,             0.0, 'u'},
  {"phase29",      'w', DAS4_A1,  8,                0.5,             0.0, 'u'},
  {"phase30",      'w', DAS4_A2,  8,                0.5,             0.0, 'u'},
  {"phase31",      'w', DAS4_A3,  8,                0.5,             0.0, 'u'},
  //generic names should be updated. Also bitfields could be useful for dig outs
  {"bias1_ampl",   'w',  BIAS_D,  0,                0.5,             0.0, 'u'},
  {"bias2_ampl",   'w',  BIAS_D,  1,                0.5,             0.0, 'u'},
  {"bias3_ampl",   'w',  BIAS_D,  2,                0.5,             0.0, 'u'},
  {"bias4_ampl",   'w',  BIAS_D,  3,                0.5,             0.0, 'u'},
  {"bias5_ampl",   'w',  BIAS_D,  4,                0.5,             0.0, 'u'},
  ...
  {"gy_ifel_offset",'w',LOOP2, 36,        1.0/32768.0,             0.0, 's'},
  {"gy_ifroll_offset",'w',LOOP2,37,       1.0/32768.0,             0.0, 's'},
  {"gy_ifyaw_offset",'w',LOOP2,38,        1.0/32768.0,             0.0, 's'},
  ...
  {"isc_gy_ifel_off",'w',LOOP5, 58,       1.0/32768.0,             0.0, 's'},
  {"osc_gy_ifel_off",'w',LOOP5, 59,       1.0/32768.0,             0.0, 's'},
  {"isc_gy_ifroll_off",'w',LOOP5,60,      1.0/32768.0,             0.0, 's'},
  {"osc_gy_ifroll_off",'w',LOOP5,61,      1.0/32768.0,             0.0, 's'},
  {"isc_gy_ifyaw_off",'w', LOOP5,62,      1.0/32768.0,             0.0, 's'},
  {"osc_gy_ifyaw_off",'w', LOOP5,63,      1.0/32768.0,             0.0, 's'},
