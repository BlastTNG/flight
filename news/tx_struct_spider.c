...
struct ChannelStruct FastChannels[] = {
  ...
  {"test2_a09",    'r', TEST2, 18,                1.0,             0.0, 'u'},
  {"test2_a10",    'r', TEST2, 20,                1.0,             0.0, 'u'},
  {"test2_b00",    'r', TEST2,  1,                1.0,             0.0, 'u'},
  {"test2_b01",    'r', TEST2,  3,                1.0,             0.0, 'u'},
  {"test2_b02",    'r', TEST2,  5,                1.0,             0.0, 'u'},
  {"test2_b03",    'r', TEST2,  7,                1.0,             0.0, 'u'},
  {"test2_b04",    'r', TEST2,  9,                1.0,             0.0, 'u'},
  {"test2_b05",    'r', TEST2, 11,                1.0,             0.0, 'u'},
  {"test2_b06",    'r', TEST2, 13,                1.0,             0.0, 'u'},
  {"test2_b07",    'r', TEST2, 15,                1.0,             0.0, 'u'},
  {"test2_b08",    'r', TEST2, 17,                1.0,             0.0, 'u'},
  {"test2_b09",    'r', TEST2, 19,                1.0,             0.0, 'u'},
  {"test2_b10",    'r', TEST2, 21,                1.0,             0.0, 'u'},
  END_OF_CHANNELS
};
