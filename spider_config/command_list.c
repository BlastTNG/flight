...
const struct mcom mcommands[N_MCOMMANDS] = {
  ...
  {MCECMD2(sa_ramp_flux_start, "Set the SA ramp flux start", GR_TUNE,
      "Start", 0, 65535, 'i')},
  {MCECMD2(sa_ramp_flux_count, "Set the SA ramp flux count", GR_TUNE,
      "Count", 0, 65535, 'i')},
  {MCECMD2(sa_ramp_flux_step, "Set the SA ramp flux step size", GR_TUNE,
      "Step size", 0, 65535, 'i')},
  {MCECMD2(sa_ramp_bias_start, "Set the SA ramp bias start", GR_TUNE,
      "Start", 0, 65535, 'i')},
  {MCECMD2(sa_ramp_bias_count, "Set the SA ramp bias count", GR_TUNE,
      "Count", 0, 65535, 'i')},
  {MCECMD2(sa_ramp_bias_step, "Set the SA ramp bias step size", GR_TUNE,
      "Step size", 0, 65535, 'i')},
  ...
  {MCECMD2(sq1_servo_flux_start, "Set the SQ1 servo flux start", GR_TUNE,
      "Start", 0, 65535, 'i')},
  {MCECMD2(sq1_servo_flux_count, "Set the SQ1 servo flux count", GR_TUNE,
      "Count", 0, 65535, 'i')},
  {MCECMD2(sq1_servo_flux_step, "Set the SQ1 servo flux step size", GR_TUNE,
      "Step size", 0, 65535, 'i')},
  {MCECMD2(sq1_servo_bias_start, "Set the SQ1 servo bias start", GR_TUNE,
      "Start", 0, 65535, 'i')},
  {MCECMD2(sq1_servo_bias_count, "Set the SQ1 servo bias count", GR_TUNE,
      "Count", 0, 65535, 'i')},
  {MCECMD2(sq1_servo_bias_step, "Set the SQ1 servo bias step size", GR_TUNE,
      "Step size", 0, 65535, 'i')},
  ...
  {MCECMD2(sq2_servo_flux_start, "Set the SQ2 servo flux start", GR_TUNE,
      "Start", 0, 65535, 'i')},
  {MCECMD2(sq2_servo_flux_count, "Set the SQ2 servo flux count", GR_TUNE,
      "Count", 0, 65535, 'i')},
  {MCECMD2(sq2_servo_flux_step, "Set the SQ2 servo flux step size", GR_TUNE,
      "Step size", 0, 65535, 'i')},
  {MCECMD2(sq2_servo_bias_start, "Set the SQ2 servo bias start", GR_TUNE,
      "Start", 0, 65535, 'i')},
  {MCECMD2(sq2_servo_bias_count, "Set the SQ2 servo bias count", GR_TUNE,
      "Count", 0, 65535, 'i')},
  {MCECMD2(sq2_servo_bias_step, "Set the SQ2 servo bias step size", GR_TUNE,
      "Step size", 0, 65535, 'i')},
  {MCECMD2(locktest_pass_amplitude,
      "Set the 'good squid' amplitude threshold for 'off' recommendation",
      GR_MCC, "Amplitude", 0, 65535, 'i')},
  {MCECMD2(sq1_ramp_bias_start, "Set the SQ1 ramp bias start", GR_TUNE,
      "Start", 0, 65535, 'i')},
  {MCECMD2(sq1_ramp_bias_count, "Set the SQ1 ramp bias count", GR_TUNE,
      "Count", 0, 65535, 'i')},
  {MCECMD2(sq1_ramp_bias_step, "Set the SQ1 ramp bias step size", GR_TUNE,
      "Step size", 0, 65535, 'i')},
  ...
  {MCECMD2(sq1_ramp_tes_bias_start, "Set the SQ1 ramp TES bias start", GR_TUNE,
      "Start", 0, 65535, 'i')},
  {MCECMD2(sq1_ramp_tes_bias_step, "Set the SQ1 ramp TES bias count", GR_TUNE,
      "Count", 0, 65535, 'i')},
  {MCECMD2(sq1_ramp_tes_bias_count, "Set the SQ1 ramp TES bias step size",
      GR_TUNE, "Step size", 0, 65535, 'i')},
  {MCECMDC(tes_bias_idle, "Set the idle detector bias level", GR_MCC,
      "Level", 0, 65535, 'i')},
  ...
  {MCECMD1(tuning_do_plots_off, "Turn off plot generation for tuning", GR_TUNE)},
  ...
  {MCECMD2(sq1servo_safb_init, "Override start point for sq1servo call",
      GR_TUNE, "Value", 0, 65535, 'i')},
  {MCECMD2(ramp_tes_start, "Start point for the TES bias ramp", GR_MCC,
      "Start", 0, 65535, 'i')},
  {MCECMD2(ramp_tes_step, "Step size for the TES bias ramp", GR_MCC,
      "Step", -32768, 32767, 'i')},
  {MCECMD2(ramp_tes_count, "Step count for the TES bias ramp", GR_MCC,
      "Count", 0, 65535, 'i')},
  ...
  {MCECMD2(mce_data_rate, "MCE data rate", GR_MCC, "Data rate", 0, 400, 'i')},
  {MCECMD2(mce_row_len, "MCE row len", GR_MCC, "Row Len", 0, 400, 'i')},
  {MCECMD2(mce_num_rows, "MCE num rows", GR_MCC, "Num Rows", 0, 32, 'i')},
  {MCECMD2(mce_num_rows_reported, "MCE num rows reported", GR_MCC,
      "Num Rows", 0, 32, 'i')},
  ...
  {MCECMDC(mce_servo_p, "Set the servo P gain", GR_MCC, "Gain", 0, 65535, 'i')},
  {MCECMDC(mce_servo_i, "Set the servo I gain", GR_MCC, "Gain", 0, 65535, 'i')},
  {MCECMDC(mce_servo_d, "Set the servo D gain", GR_MCC, "Gain", 0, 65535, 'i')},
  {MCECMD2(frail_servo_p, "Set the frail servo P gain", GR_MCC,
      "Gain", 0, 65535, 'i')},
  {MCECMD2(frail_servo_i, "Set the frail servo I gain", GR_MCC,
      "Gain", 0, 65535, 'i')},
  {MCECMD2(frail_servo_d, "Set the frail servo D gain", GR_MCC,
      "Gain", 0, 65535, 'i')},
