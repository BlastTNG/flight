...
enum multiCommand {
  ...
  thegood_bad_pix,    thegood_blob_params, thegood_platescale,
  thegood_lens_any,   thegood_lens_move, thegood_viewer,
  thebad_bad_pix,     thebad_blob_params, thebad_platescale,
  thebad_lens_any,    thebad_lens_move,
  theugly_bad_pix,    theugly_blob_params, theugly_platescale,
  ...
  flux_loop_init, lcloop, squid_veto, squid_unveto,
  ...
  dead_detector, frail_detector, healthy_detector, tes_bias, sa_flux_quantum,
