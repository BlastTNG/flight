...
enum multiCommand {
  ...
  thebad_exp_params,  thebad_focus_params,
  ...
  sq1_ramp_tes_bias_on, sq1_ramp_tes_bias_off, sq1_ramp_tes_bias_start,
  sq1_ramp_tes_bias_step, sq1_ramp_tes_bias_count, tes_bias_idle,
  ...
  ramp_tes_count, ramp_tes_final_bias, ramp_tes_initial_pause, ramp_tes_period,
  mce_data_rate, mce_row_len, mce_num_rows, mce_num_rows_reported,
  readout_row_index, sample_dly, sample_num, fb_dly, row_dly, flux_jumping_on,
  flux_jumping_off, mce_servo_mode, mce_servo_p, mce_servo_d, mce_servo_i,
  frail_servo_p, frail_servo_i, frail_servo_d, dead_detector, frail_detector,
