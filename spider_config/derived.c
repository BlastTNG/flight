...
union DerivedUnion DerivedChannels[] = {
  ...
  BITFIELD("alarm_lo_of_cc",
      ...
      "A_RTS_DISCONN_OF_CC",
      "A_TSENSE_OPEN_OF_CC",
      "A_TSENSE_SHORT_OF_CC",
      "A_HITEMP_LIM_OF_CC",
      "A_CURRENT_LIM_OF_CC",
      "A_CURRENT_OFFS_OF_CC",
      "A_BATTSENS_RNG_OF_CC",
      "A_BATTSENS_DSC_OF_CC",
      "A_UNCALIB_OF_CC",
      "A_RTS_MISWIRE_OF_CC",
      "A_HVD_OF_CC",
      "",
 ...
 BITFIELD("alarm_hi_of_cc",
  ...
  BITFIELD("alarm_lo_if_cc",
      ...
      "A_RTS_DISCONN_IF_CC",
      "A_TSENSE_OPEN_IF_CC",
      "A_TSENSE_SHORT_IF_CC",
      "A_HITEMP_LIM_IF_CC",
      "A_CURRENT_LIM_IF_CC",
      "A_CURRENT_OFFS_IF_CC",
      "A_BATTSENS_RNG_IF_CC",
      "A_BATTSENS_DSC_IF_CC",
      "A_UNCALIB_IF_CC",
      "A_RTS_MISWIRE_IF_CC",
      "A_HVD_IF_CC",
      "",
