...
#define CNX_HK(ch, i, lut) \
  ...
  T_HK("TD_4K_4_HK",	 "VD_00_4_HK",	LUT_DIR "d_simonchase2.lut"),
  T_HK("TD_CP_4_HK",	 "VD_01_4_HK",	LUT_DIR "d_simonchase2.lut"),
  T_HK("TD_PUMP_4_HK",	 "VD_02_4_HK",	LUT_DIR "d_simonchase2.lut"),
  T_HK("TD_HSW_4_HK",	 "VD_03_4_HK",	LUT_DIR "d_simonchase2.lut"),
  T_HK("TD_PLATE_4_HK",	 "VD_04_4_HK",	LUT_DIR "D87587.lut"),
  T_HK("TD_SNOUT_4_HK",	 "VD_05_4_HK",	LUT_DIR "d_curve10.lut"),
  T_HK("TD_EYEPIECE_4_HK",	 "VD_06_4_HK",	LUT_DIR "D77241.lut"),
  T_HK("TD_OBJECTIVE_4_HK",	 "VD_07_4_HK",	LUT_DIR "d_curve10.lut"),
  T_HK("TD_SC_SHIELD_4_HK",	 "VD_08_4_HK",	LUT_DIR "D78318.lut"),
  T_HK("TD_AUX_POST_4_HK",	 "VD_09_4_HK",	LUT_DIR "D77243.lut"),
  T_HK("TD_STOP_4_HK",	 "VD_10_4_HK",	LUT_DIR "d_curve10.lut"),
  T_HK("TD_SSA_4_HK",	 "VD_11_4_HK",	LUT_DIR "d_curve10.lut"),
