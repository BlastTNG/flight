...
struct ChannelStruct SlowChannels[] = {
  ...
  {"ra_g",             'w', LOOP3,  8,        1.0/100.0,  0.0, 's',     U_NONE},
  {"dec_g",            'w', LOOP3,  9,        1.0/100.0,  0.0, 's',     U_NONE},
  {"roll_g",           'w', LOOP3, 10,        1.0/100.0,  0.0, 's',     U_NONE},
  {"ra_b",             'w', LOOP3, 11,        1.0/100.0,  0.0, 's',     U_NONE},
  {"foc_res_b",        'w', LOOP3, 12,              1.0,  0.0, 'u',     U_NONE},
  {"dec_b",            'w', LOOP3, 13,        1.0/100.0,  0.0, 's',     U_NONE},
  {"roll_b",           'w', LOOP3, 14,        1.0/100.0,  0.0, 's',     U_NONE},
  ...
  {"ra_u",             'w', LOOP3, 20,        1.0/100.0,  0.0, 's',     U_NONE},
  {"dec_u",            'w', LOOP3, 21,        1.0/100.0,  0.0, 's',     U_NONE},
  {"roll_u",           'w', LOOP3, 22,        1.0/100.0,  0.0, 's',     U_NONE},
  ...
  {"az_g",             'w', LOOP3, 27,        1.0/100.0,  0.0, 'u',     U_NONE},
  {"el_g",             'w', LOOP3, 28,        1.0/100.0,  0.0, 's',     U_NONE},
  {"az_b",             'w', LOOP3, 29,        1.0/100.0,  0.0, 'u',     U_NONE},
  {"el_b",             'w', LOOP3, 30,        1.0/100.0,  0.0, 's',     U_NONE},
  {"az_u",             'w', LOOP3, 31,        1.0/100.0,  0.0, 'u',     U_NONE},
  {"el_u",             'w', LOOP3, 32,        1.0/100.0,  0.0, 's',     U_NONE},
...
/* ACS2 Analog card */
  ...
  {"t_mcc3",          'w',  LOOP7, 38, 0.01,  0.0, 'u', U_NONE},
  {"t_mcc4",          'w',  LOOP7, 39, 0.01,  0.0, 'u', U_NONE},
  {"t_mcc5",          'w',  LOOP7, 40, 0.01,  0.0, 'u', U_NONE},
  {"t_mcc6",          'w',  LOOP7, 41, 0.01,  0.0, 'u', U_NONE},

  {"t_mce1",          'w',  LOOP7, 42, 0.5,   0.0, 'u', U_NONE},
  {"t_mce2",          'w',  LOOP7, 43, 0.5,   0.0, 'u', U_NONE},
  {"t_mce3",          'w',  LOOP7, 44, 0.5,   0.0, 'u', U_NONE},
  {"t_mce4",          'w',  LOOP7, 45, 0.5,   0.0, 'u', U_NONE},
  {"t_mce5",          'w',  LOOP7, 46, 0.5,   0.0, 'u', U_NONE},
  {"t_mce6",          'w',  LOOP7, 47, 0.5,   0.0, 'u', U_NONE},
