...
struct ChannelStruct WideSlowChannels[] = {
  ...
  {"start_x1_cycle",  'w', LOOP0,  12,                1.0,            0.0, 'U', U_NONE},
  {"start_x2_cycle",  'w', LOOP0,  14,                1.0,            0.0, 'U', U_NONE},
  {"start_x3_cycle",  'w', LOOP0,  16,                1.0,            0.0, 'U', U_NONE},
  {"start_x4_cycle",  'w', LOOP0,  18,                1.0,            0.0, 'U', U_NONE},
  {"start_x5_cycle",  'w', LOOP0,  20,                1.0,            0.0, 'U', U_NONE},
  {"start_x6_cycle",  'w', LOOP0,  22,                1.0,            0.0, 'U', U_NONE},
  //LOOP0 24-29 are narrow
  {"start_state_x1_cycle",  'w', LOOP0,  30,                1.0,            0.0, 'U', U_NONE},
  {"start_state_x2_cycle",  'w', LOOP0,  32,                1.0,            0.0, 'U', U_NONE},
  {"start_state_x3_cycle",  'w', LOOP0,  34,                1.0,            0.0, 'U', U_NONE},
  {"start_state_x4_cycle",  'w', LOOP0,  36,                1.0,            0.0, 'U', U_NONE},
  {"start_state_x5_cycle",  'w', LOOP0,  38,                1.0,            0.0, 'U', U_NONE},
  {"start_state_x6_cycle",  'w', LOOP0,  40,                1.0,            0.0, 'U', U_NONE},
...
/* housekeeping channels */  /* TODO many can probably be slow */
  ...
  {"mce_frameno", 'r', LOOP1,   0,                1.0,             0.0, 'U',
    U_NONE},
