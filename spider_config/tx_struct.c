...
struct ChannelStruct SlowChannels[] = {
  ...
  {"ra_g",             'w', LOOP3,  8,             LI2H,  0.0, 'u',     U_P_HR},
  {"dec_g",            'w', LOOP3,  9,           LI2DEG,  0.0, 's',    U_P_DEG},
  {"roll_g",           'w', LOOP3, 10,           LI2DEG,  0.0, 'u',    U_P_DEG},
  {"ra_b",             'w', LOOP3, 11,             LI2H,  0.0, 'u',     U_P_HR},
  {"foc_res_b",        'w', LOOP3, 12,              1.0,  0.0, 'u',     U_NONE},
  {"dec_b",            'w', LOOP3, 13,           LI2DEG,  0.0, 's',    U_P_DEG},
  {"roll_b",           'w', LOOP3, 14,           LI2DEG,  0.0, 'u',    U_P_DEG},
  ...
  {"ra_u",             'w', LOOP3, 20,             LI2H,  0.0, 'u',     U_P_HR},
  {"dec_u",            'w', LOOP3, 21,           LI2DEG,  0.0, 's',    U_P_DEG},
  {"roll_u",           'w', LOOP3, 22,           LI2DEG,  0.0, 'u',    U_P_DEG},
  ...
  {"az_g",             'w', LOOP3, 27,           LI2DEG,  0.0, 'u',    U_P_DEG},
  {"el_g",             'w', LOOP3, 28,           LI2DEG,  0.0, 'u',    U_P_DEG},
  {"az_b",             'w', LOOP3, 29,           LI2DEG,  0.0, 'u',    U_P_DEG},
  {"el_b",             'w', LOOP3, 30,           LI2DEG,  0.0, 'u',    U_P_DEG},
  {"az_u",             'w', LOOP3, 31,           LI2DEG,  0.0, 'u',    U_P_DEG},
  {"el_u",             'w', LOOP3, 32,           LI2DEG,  0.0, 'u',    U_P_DEG},
