...
public:
  ...
  /** Reads a field from the file.  Data is returned in the
      double Array V[] */
  int readField(double *V, const QString &field, const int &s,
                const int &n);

  /** Returns true if the field is valid, or false if it is not */
  bool isValidField(const char *field);
  bool isValidField(const QString &field);
...
private: // Private methods
  ...
  int asciiReadField(double *V, const QString &field, const int &s,
                     const int &n);
  ...
  /** Returns true if the field is valid, or false if it is not */
  bool asciiIsValidField(const QString &field);

  /** Read a field from a frame file */
  int frameReadField(double *V, const QString &field, const int &s,
                     const int &n);
  ...
  /** Returns true if the field is valid, or false if it is not */
  bool dirfileIsValidField(const QString &field);
