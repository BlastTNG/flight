...
BLASTCMD_UPLOAD="cd $BLASTCMD_BUILD_DIR; scp blastcmd fc1user@fc1.ldb:~/; scp blastcmd fc1user@fc2.ldb:~/"
...
ssh -t fc1user@fc1.ldb "$BLASTCMD_INSTALL_FC; $BLASTCMD_RESTART_CMD"
ssh -t fc1user@fc2.ldb "$BLASTCMD_INSTALL_FC; $BLASTCMD_RESTART_CMD"
