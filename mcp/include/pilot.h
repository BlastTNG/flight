...
#define PILOT_MAX_PACKET_SIZE 200000 // maximum size of a packet to be sent over Pilot
#define PILOT_MAX_SIZE 200000 // maximum compressed frame size to be send over Pilot
