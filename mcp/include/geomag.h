...
#include <math.h>
#define GEOMAG_WMM "/data/etc/WMM.COF"
#define GEOMAG_GEOID "/data/etc/EGM9615.BIN"

#define WMM_RAD2DEG(rad)    ((rad)*(180.0L/M_PI))
#define WMM_DEG2RAD(deg)    ((deg)*(M_PI/180.0L))
#define WMM_ATanH(x)	    (0.5 * log((1 + x) / (1 - x)))
 ...
 */
 ...
 void GetMagModel(double alt, double glat, double glon, double time, double *dec, double *dip);
