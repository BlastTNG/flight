...
void MultiCommand (enum multiCommand command, unsigned short *dataq) {
  ...
  if (command == az_el_goto) {
    ...
    CommandData.pumps.bal_min = 2047 - rvalues[1] * 2047. / 100;
    CommandData.pumps.bal_max = 2047 - rvalues[2] * 2047. / 100;
