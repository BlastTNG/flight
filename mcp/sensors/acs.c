...
void store_100hz_xsc(int which)
{
    ...
    static channel_t* address_xN_predicted_streaking_px;
    ...
    if (firsttime[which]) {
        ...
        if (which == 0) {
            ...
            address_xN_predicted_streaking_px         = get_xsc_channel("predicted_streaking_px", which);
        }
    ...
    if (which == 0) {
        ...
        SET_SCALED_VALUE(address_xN_predicted_streaking_px, xsc_pointing_state[0].predicted_streaking_px);
    }
