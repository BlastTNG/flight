...
struct ChannelStruct SlowChList[N_SLOW][FAST_PER_SLOW] = {
  ...
  },
  {
    ...
    {"isc_save_prd", 'r', LOOPBAK3, 2,          0.01,             0.0, 'u'},
  ...
  },
  {
    ...
    {"sun_az",       'w', LOOPBACK, 21,        I2DEG,             0.0, 's'},
  ...
  },
  {
    ...
    {"isc_error",    'w', LOOPBACK, 41,            1.,             0.0, 'u'},
    {"isc_mapmean",  'w', LOOPBACK, 42,            1.,             0.0, 'u'},
  ...
  },
  {
    ...
    {"bal_min",      'w', LOOPBAK2, 31,    100./2047.,             0.0, 'u'},
    {"bal_max",      'w', LOOPBAK2, 32,    100./2047.,             0.0, 'u'},
  ...
  },
  {
    ...
    {"isc_spulse",   'w', LOOPBAK2, 57,          10.0,             0.0, 'u'},
    ...
    {"t_baffle",     'r',  4, 33,            -0.00625,          136.45, 'u'},
    {"t_rec",        'r',  4, 35,            -0.00625,          136.45, 'u'},
    {"t_if12",       'r',  4, 37,            -0.00625,          136.45, 'u'},
    {"t_battery",    'r',  2,  1,            -0.00625,          136.45, 'u'},
    {"t_out_heatx",  'r',  2,  3,            -0.00625,          136.45, 'u'},
    {"t_scoop_tip",  'r',  2, 17,            -0.00625,          136.45, 'u'},
    {"t_fl_sshield", 'r',  2, 19,            -0.00625,          136.45, 'u'},
    {"t_fr_sshield", 'r',  2, 21,            -0.00625,          136.45, 'u'},
    {"t_bl_sshield", 'r',  2, 23,            -0.00625,          136.45, 'u'},
    {"t_br_sshield", 'r',  2, 25,            -0.00625,          136.45, 'u'},
  },
  {
    {"t_el_bearing", 'r',  2, 27,            -0.00625,          136.45, 'u'},
    {"t_lock_motor", 'r',  2, 29,            -0.00625,          136.45, 'u'},
    {"t_sun_sensor", 'r',  2, 31,            -0.00625,          136.45, 'u'},
    {"isc_x_off",    'w', LOOPBAK2, 63,         I2DEG,             0.0, 'u'},
    {"isc_y_off",    'w', LOOPBAK3,  3,         I2DEG,             0.0, 'u'},
