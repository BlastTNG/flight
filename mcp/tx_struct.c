...
struct ChannelStruct SlowChList[N_SLOW][FAST_PER_SLOW] = {
  ...
  },
  {
    ...
    {"isc_sigma",    'w', LOOPBAK2, 28,        I2DEG,             0.0, 'u'},
    ...
    {"lokmot_pin",   'w', LOOPBACK, 19,          1.0,             0.0, 'u'}
  },
  {
  ...
  },
  {
    ...
    {"bal_gain",     'w', LOOPBAK2, 29,      1/1000.,             0.0, 'u'}
  },
  {
    ...
    {"bal_on",       'w', LOOPBACK, 24,     1./1648.,             0.0, 'u'},
    {"bal_off",      'w', LOOPBACK, 25,     1./1648.,             0.0, 'u'},
    {"bal_target",   'w', LOOPBACK, 26,     1./1648.,             0.0, 'u'},
    {"bal_veto",     'w', LOOPBACK, 27,          1.0,             0.0, 'u'},
  ...
  },
  {
    ...
    {"isc_framenum", 'w', LOOPBACK, 63,          1.0,             0.0, 'u'},
    ...
    {"blob0_sn",     'w', LOOPBAK2, 3,  1000./65536.,             0.0, 'u'},
    {"blob1_sn",     'w', LOOPBAK2, 4,  1000./65536.,             0.0, 'u'},
    {"blob2_sn",     'w', LOOPBAK2, 5,  1000./65536.,             0.0, 'u'}
  },
  {
    ...
    {"sip_alt",      'w', LOOPBACK, 22,           4.0,             0.0, 'u'},
    {"lat",          'w', LOOPBACK, 28,         I2DEG,             0.0, 'u'},
    {"lon",          'w', LOOPBACK, 29,         I2DEG,             0.0, 'u'},
    {"cal_puls",     'w',  3,    7,               1.0,             0.0, 'u'},
    {"p_az_mode",    'w', LOOPBACK, 33,           1.0,             0.0, 'u'},
    {"p_az1",        'w', LOOPBACK, 34,         I2DEG,             0.0, 'u'},
    {"p_az2",        'w', LOOPBACK, 35,         I2DEG,             0.0, 'u'},
    {"p_el1",        'w', LOOPBACK, 36,         I2DEG,             0.0, 'u'},
    {"p_el2",        'w', LOOPBACK, 37,         I2DEG,             0.0, 'u'},
    {"blob0_x",      'w', LOOPBAK2,  0,        1./40.,             0.0, 'u'},
  ...
  },
  {
    ...
    {"sip_lon",      'w', LOOPBACK, 21,         I2DEG,             0.0, 'u'},
    {"dgps_lat",     'w', LOOPBACK, 16,         I2DEG,             0.0, 'u'},
    {"dgps_lon",     'w', LOOPBACK, 23,         I2DEG,             0.0, 'u'},
    {"dgps_alt",     'w', LOOPBACK, 52,           1.0,             0.0, 'u'},
    {"dgps_speed",   'w', LOOPBACK, 53,         I2DEG,             0.0, 'u'},
  ...
  },
  {
    ...
    {"pch_clin_pyr", 'r', 21, 33,      4.0/5333.3333,       -4.*6.144, 'u'},
    {"p_az_vel",     'w', LOOPBACK, 38,           I2VEL,           0.0, 's'},
    {"p_el_vel",     'w', LOOPBACK, 39,           I2VEL,           0.0, 's'},
    {"p_ra",         'w', LOOPBACK, 44,           I2H,             0.0, 'u'},
    {"p_dec",        'w', LOOPBACK, 45,         I2DEG,             0.0, 'u'},
    {"p_r",          'w', LOOPBACK, 46,         I2DEG,             0.0, 'u'},
    {"p_el_mode",    'w', LOOPBACK, 47,           1.0,             0.0, 'u'},
    ...
    {"blob0_flux",   'w', LOOPBAK2, 16,          32.0,             0.0, 'u'},
    {"blob1_flux",   'w', LOOPBAK2, 17,          32.0,             0.0, 'u'},
  ...
  },
  {
    ...
    {"isc_mtol",    'w', LOOPBAK2, 33,           1.0,             0.0, 'u'},
    {"isc_qtol",    'w', LOOPBAK2, 34,           1.0,             0.0, 'u'},
    {"isc_rtol",    'w', LOOPBAK2, 35,           1.0,             0.0, 'u'},
    {"spare07",     'w', SPARE,  7,              1.0,             0.0, 'u'},
    {"spare08",     'w', SPARE,  8,              1.0,             0.0, 'u'},
    {"spare09",     'w', SPARE,  9,              1.0,             0.0, 'u'},
    {"spare10",     'w', SPARE, 10,              1.0,             0.0, 'u'},
    {"spare11",     'w', SPARE, 11,              1.0,             0.0, 'u'},
    {"spare12",     'w', SPARE, 12,              1.0,             0.0, 'u'},
    {"spare13",     'w', SPARE, 13,              1.0,             0.0, 'u'},
    {"spare14",     'w', SPARE, 14,              1.0,             0.0, 'u'},
    {"spare15",     'w', SPARE, 15,              1.0,             0.0, 'u'},
    {"spare16",     'w', SPARE, 16,              1.0,             0.0, 'u'},
    {"spare17",     'w', SPARE, 17,              1.0,             0.0, 'u'},
    {"spare18",     'w', SPARE, 18,              1.0,             0.0, 'u'},
    {"spare19",     'w', SPARE, 19,              1.0,             0.0, 'u'},
    {"spare20",     'w', SPARE, 20,              1.0,             0.0, 'u'}
  }
}; 
