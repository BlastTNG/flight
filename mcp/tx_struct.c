...
struct ChannelStruct SlowChannels[] = {
  ...
  {"force_sbsc",     'w', LOOP8, 41,                1.0,             0.0, 'u'},
  {"exp_int_sbsc",   'w', LOOP8, 42,                1.0,             0.0, 'u'},
  {"exp_time_sbsc",  'w', LOOP8, 43,                1.0,             0.0, 'u'},
  {"foc_res_sbsc",   'w', LOOP8, 44,                1.0,             0.0, 'u'},
  {"move_tol_sbsc",  'w', LOOP8, 45,                1.0,             0.0, 'u'},
  {"maxblob_sbsc",   'w', LOOP8, 46,                1.0,             0.0, 'u'},
  {"grid_sbsc",      'w', LOOP8, 47,                1.0,             0.0, 'u'},
  {"thresh_sbsc",    'w', LOOP8, 48,         1.0/1000.0,             0.0, 'u'},
  {"mdist_sbsc",     'w', LOOP8, 49,                1.0,             0.0, 'u'},
  {"mapmean_sbsc",   'w', LOOP8, 50,                1.0,             0.0, 'u'},
  {"mapsigma_sbsc",  'w', LOOP8, 51,           1.0/10.0,             0.0, 'u'},
  {"ccd_t_sbsc",     'w', LOOP8, 52,          1.0/100.0,             0.0, 's'},
  {"numblobs_sbsc",  'w', LOOP8, 53,                1.0,             0.0, 'u'},
  {"blob00_x_sbsc",  'w', LOOP8, 54, CAM_WIDTH/SHRT_MAX,             0.0, 'u'},
  {"blob00_y_sbsc",  'w', LOOP8, 55, CAM_WIDTH/SHRT_MAX,             0.0, 'u'}, 
  {"blob00_f_sbsc",  'w', LOOP8, 56,                1.0,             0.0, 'u'},
  {"blob00_s_sbsc",  'w', LOOP8, 57,          1.0/100.0,             0.0, 'u'},
  {"blob01_x_sbsc",  'w', LOOP8, 58, CAM_WIDTH/SHRT_MAX,             0.0, 'u'},
  {"blob01_y_sbsc",  'w', LOOP8, 59, CAM_WIDTH/SHRT_MAX,             0.0, 'u'}, 
  {"blob01_f_sbsc",  'w', LOOP8, 60,                1.0,             0.0, 'u'},
  {"blob01_s_sbsc",  'w', LOOP8, 61,          1.0/100.0,             0.0, 'u'},
  {"blob02_x_sbsc",  'w', LOOP8, 62, CAM_WIDTH/SHRT_MAX,             0.0, 'u'},
