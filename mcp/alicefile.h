...
typedef enum {UNKNOWN, EMPTY, FRAME, ASCII, DIRFILE} AliceFileType;
...
class AliceFile {
public:
  AliceFile(const char *filename_in,
          const AliceFileType newType = UNKNOWN);
  AliceFile(QDomElement &e);
  ~AliceFile();
