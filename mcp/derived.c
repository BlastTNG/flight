...
union DerivedUnion DerivedChannels[] = {
  ...
  BITWORD("RW_INFO_ERR","rw_drive_info",10,5),
  BITWORD("RW_INFO_DISAB","rw_drive_info",4,2),
  BITWORD("RW_INFO_BDRATE","rw_drive_info",6,2),
  BITWORD("RW_INFO_WRSET","rw_drive_info",8,2),
  LINCOM2("RW_INFO_IO","RW_INFO_OPEN",1,0,"RW_INFO_INIT_1",10,0),
  LINCOM2("RW_INFO_RIO","RW_INFO_RESET",100,0,"RW_INFO_IO",1,0),

  BITFIELD("el_drive_info",
	   "EL_INFO_OPEN",
	   "EL_INFO_RESET",
	   "EL_INFO_INIT_1",
	   "EL_INFO_INIT_2",
  ...
  BITWORD("EL_INFO_ERR","el_drive_info",10,5),
  BITWORD("EL_INFO_DISAB","el_drive_info",4,2),
  BITWORD("EL_INFO_BDRATE","el_drive_info",6,2),
  BITWORD("EL_INFO_WRSET","el_drive_info",8,2),
  LINCOM2("EL_INFO_IO","EL_INFO_OPEN",1,0,"EL_INFO_INIT_1",10,0),
  LINCOM2("EL_INFO_RIO","EL_INFO_RESET",100,0,"EL_INFO_IO",1,0),
  BITFIELD("piv_drive_info",
	   "PIV_INFO_OPEN",
	   "PIV_INFO_RESET",
	   "PIV_INFO_INIT_1",
	   "PIV_INFO_INIT_2",
  ...
  BITWORD("PIV_INFO_ERR","piv_drive_info",10,5),
  BITWORD("PIV_INFO_DISAB","piv_drive_info",4,2),
  BITWORD("PIV_INFO_BDRATE","piv_drive_info",6,2),
  BITWORD("PIV_INFO_WRSET","piv_drive_info",8,2),
  LINCOM2("PIV_INFO_IO","PIV_INFO_OPEN",1,0,"PIV_INFO_INIT_1",10,0),
  LINCOM2("PIV_INFO_RIO","PIV_INFO_RESET",100,0,"PIV_INFO_IO",1,0),
  BITFIELD("el_fault",
	   "EL_F_CRC",
	   "EL_F_AD_OFF_RANGE",
	   "EL_F_SHORT_CIRC",
