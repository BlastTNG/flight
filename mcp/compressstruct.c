...
struct fieldStreamStruct streamList[] = {
  ...
  {"az_ss", 1, 5, NOAVG, DX, 8, SLOW},
  {"az_dgps", 1, 5, NOAVG, DX, 8, SLOW},
  {"az_mag", 1, 5, NOAVG, DX, 8, SLOW},
  {"az_raw_dgps", 1, 5, NOAVG, DX, 8, SLOW},
  {"az_rel_sun_ss", 1, 5, NOAVG, DX, 8, SLOW},
  {"az_pss1", 1, 5, NOAVG, DX, 8, SLOW},
  {"az_pss2", 1, 5, NOAVG, DX, 8, SLOW},
