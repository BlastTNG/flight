...
struct SlowDLStruct SlowDLInfo[SLOWDL_NUM_DATA] = {
    ...
    {"vt_port_das",    SLOWDL_U_MASK, 16},
    {"vt_port_rec",    SLOWDL_U_MASK, 16},
    {"t_padcdc_rec",  SLOWDL_U_MASK, 16},
    {"t_gy",          SLOWDL_U_MASK, 16},
    {"vt_1_bat",       SLOWDL_U_MASK, 16},
    {"vt_array",       SLOWDL_U_MASK, 16},
    {"t_prime_sf",    SLOWDL_U_MASK, 16},
    {"t_second_sf",   SLOWDL_U_MASK, 16},
    {"vt_chin",        SLOWDL_U_MASK, 16},
    {"vt_earth",       SLOWDL_U_MASK, 16},
