...
/* TODO this file needs updating to be brought in line with tx_struct
 * for now, misbehaved fields will be commented out, but many of them probably
 * have new couterparts, so just need renaming
 */
