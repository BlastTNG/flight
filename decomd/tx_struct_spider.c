...
#define CAL32D(m,b) CAL32((m) / 0.994 / 4.0, (b))
...
struct ChannelStruct SlowChannels[] = {
  ...
  {"heat_ssa_2_hk", 'w', RTD_D,   2, CALDAC(  0.996,      -0.001), 'u',  U_V_V},
  {"heat_fplo_2_hk",'w', RTD_D,   3, CALDAC(  0.997,      -0.001), 'u',  U_V_V},
  {"v_cnx_1_hk",    'w', RTD_D,   4, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"v_ntd_1_hk",    'w', RTD_D,   5, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"heat_ssa_1_hk", 'w', RTD_D,   6, CALDAC(  0.997,      -0.001), 'u',  U_V_V},
  {"heat_fplo_1_hk",'w', RTD_D,   7, CALDAC(  0.998,      -0.001), 'u',  U_V_V},
  {"v_cnx_3_hk",    'w', RTD_D,   8, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"v_ntd_3_hk",    'w', RTD_D,   9, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"heat_ssa_3_hk", 'w', RTD_D,  10, CALDAC(  1.000,      -0.001), 'u',  U_V_V},
  {"heat_fplo_3_hk",'w', RTD_D,  11, CALDAC(  1.001,      -0.001), 'u',  U_V_V},
  {"v_cnx_4_hk",    'w', RTD_D,  12, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"v_ntd_4_hk",    'w', RTD_D,  13, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"heat_ssa_4_hk", 'w', RTD_D,  14, CALDAC(  1.003,      -0.001), 'u',  U_V_V},
  {"heat_fplo_4_hk",'w', RTD_D,  15, CALDAC(  0.998,      -0.001), 'u',  U_V_V},
  {"v_cnx_6_hk",    'w', RTD_D,  16, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"v_ntd_6_hk",    'w', RTD_D,  17, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"heat_ssa_6_hk", 'w', RTD_D,  18, CALDAC(  0.997,      -0.001), 'u',  U_V_V},
  {"heat_fplo_6_hk",'w', RTD_D,  19, CALDAC(  1.003,      -0.001), 'u',  U_V_V},
  {"v_cnx_5_hk",    'w', RTD_D,  20, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"v_ntd_5_hk",    'w', RTD_D,  21, CALDAC(    1.0,         0.0), 'u',  U_V_V},
  {"heat_ssa_5_hk", 'w', RTD_D,  22, CALDAC(  0.999,      -0.001), 'u',  U_V_V},
  {"heat_fplo_5_hk",'w', RTD_D,  23, CALDAC(  0.998,      -0.001), 'u',  U_V_V},
...
/* housekeeping channels */  /* TODO many can probably be slow */
  //HK7 cal
  {"vr_still_2_hk",  'r', RTD_A1,  0, CAL32C(       1.155,           0.0), 'U', U_V_V},
  {"vr_mux_2_hk",    'r', RTD_A1,  2, CAL32C(       1.159,           0.0), 'U', U_V_V},
  {"vr_ntd1_2_hk",   'r', RTD_A1,  4, CAL32N(       1.276,           0.0), 'U', U_V_V},
  {"vr_fp_2_hk",     'r', RTD_A1,  6, CAL32C(       1.161,           0.0), 'U', U_V_V},
  {"vr_ssa_2_hk",    'r', RTD_A1,  8, CAL32C(       1.162,           0.0), 'U', U_V_V},
  {"vr_ntd4_2_hk",   'r', RTD_A1, 10, CAL32N(       1.273,           0.0), 'U', U_V_V},
  {"vr_ntd3_2_hk",   'r', RTD_A1, 12, CAL32N(       1.298,           0.0), 'U', U_V_V},
  {"vr_ntd2_2_hk",   'r', RTD_A1, 14, CAL32N(       1.286,           0.0), 'U', U_V_V},
  /*
  {"vr_still_2_hk",  'r', RTD_A1,  0, CAL32C(       1.159,           0.0), 'U', U_V_V},
  {"vr_mux_2_hk",    'r', RTD_A1,  2, CAL32C(       1.163,           0.0), 'U', U_V_V},
  {"vr_ntd1_2_hk",   'r', RTD_A1,  4, CAL32N(       1.283,           0.0), 'U', U_V_V},
  {"vr_fp_2_hk",     'r', RTD_A1,  6, CAL32C(       1.156,           0.0), 'U', U_V_V},
  {"vr_ssa_2_hk",    'r', RTD_A1,  8, CAL32C(       1.155,           0.0), 'U', U_V_V},
  {"vr_ntd4_2_hk",   'r', RTD_A1, 10, CAL32N(       1.284,           0.0), 'U', U_V_V},
  {"vr_ntd3_2_hk",   'r', RTD_A1, 12, CAL32N(       1.281,           0.0), 'U', U_V_V},
  {"vr_ntd2_2_hk",   'r', RTD_A1, 14, CAL32N(       1.284,           0.0), 'U', U_V_V},
  */
  {"vr_still_3_hk",  'r', RTD_A1, 16, CAL32C(       1.158,           0.0), 'U', U_V_V},
  {"vr_mux_3_hk",    'r', RTD_A1, 18, CAL32C(       1.159,           0.0), 'U', U_V_V},
  {"vr_ntd1_3_hk",   'r', RTD_A1, 20, CAL32N(       1.272,           0.0), 'U', U_V_V},
  {"vr_fp_3_hk",     'r', RTD_A1, 22, CAL32C(       1.150,           0.0), 'U', U_V_V},
  {"vr_ssa_3_hk",    'r', RTD_A1, 24, CAL32C(       1.158,           0.0), 'U', U_V_V},
  {"vr_ntd4_3_hk",   'r', RTD_A1, 26, CAL32N(       1.268,           0.0), 'U', U_V_V},
  {"vr_ntd3_3_hk",   'r', RTD_A1, 28, CAL32N(       1.266,           0.0), 'U', U_V_V},
  {"vr_ntd2_3_hk",   'r', RTD_A1, 30, CAL32N(       1.279,           0.0), 'U', U_V_V},
  /*
  {"vr_still_1_hk",  'r', RTD_A1, 32, CAL32C(       1.148,           0.0), 'U', U_V_V},
  {"vr_mux_1_hk",    'r', RTD_A1, 34, CAL32C(       1.146,           0.0), 'U', U_V_V},
  {"vr_ntd1_1_hk",   'r', RTD_A1, 36, CAL32N(       1.284,           0.0), 'U', U_V_V},
  {"vr_fp_1_hk",     'r', RTD_A1, 38, CAL32C(       1.150,           0.0), 'U', U_V_V},
  {"vr_ssa_1_hk",    'r', RTD_A1, 40, CAL32C(       1.153,           0.0), 'U', U_V_V},
  {"vr_ntd4_1_hk",   'r', RTD_A1, 42, CAL32N(       1.275,           0.0), 'U', U_V_V},
  {"vr_ntd3_1_hk",   'r', RTD_A1, 44, CAL32N(       1.301,           0.0), 'U', U_V_V},
  {"vr_ntd2_1_hk",   'r', RTD_A1, 46, CAL32N(       1.276,           0.0), 'U', U_V_V},
  */
  //HK0 cal
  {"vr_still_1_hk",  'r', RTD_A1, 32, CAL32C(       1.212,           0.0), 'U', U_V_V},
  {"vr_mux_1_hk",    'r', RTD_A1, 34, CAL32C(       1.142,           0.0), 'U', U_V_V},
  {"vr_ntd1_1_hk",   'r', RTD_A1, 36, CAL32N(       1.278,           0.0), 'U', U_V_V},
  {"vr_fp_1_hk",     'r', RTD_A1, 38, CAL32C(       1.150,           0.0), 'U', U_V_V},
  {"vr_ssa_1_hk",    'r', RTD_A1, 40, CAL32C(       1.153,           0.0), 'U', U_V_V},
  {"vr_ntd4_1_hk",   'r', RTD_A1, 42, CAL32N(       1.281,           0.0), 'U', U_V_V},
  {"vr_ntd3_1_hk",   'r', RTD_A1, 44, CAL32N(       1.278,           0.0), 'U', U_V_V},
  {"vr_ntd2_1_hk",   'r', RTD_A1, 46, CAL32N(       1.271,           0.0), 'U', U_V_V},

  {"vr_still_5_hk",  'r', RTD_A2,  0, CAL32C(       1.144,           0.0), 'U', U_V_V},
  {"vr_mux_5_hk",    'r', RTD_A2,  2, CAL32C(       1.155,           0.0), 'U', U_V_V},
  {"vr_ntd1_5_hk",   'r', RTD_A2,  4, CAL32N(       1.274,           0.0), 'U', U_V_V},
  {"vr_fp_5_hk",     'r', RTD_A2,  6, CAL32C(       1.154,           0.0), 'U', U_V_V},
  {"vr_ssa_5_hk",    'r', RTD_A2,  8, CAL32C(       1.141,           0.0), 'U', U_V_V},
  {"vr_ntd4_5_hk",   'r', RTD_A2, 10, CAL32N(       1.268,           0.0), 'U', U_V_V},
  {"vr_ntd3_5_hk",   'r', RTD_A2, 12, CAL32N(       1.275,           0.0), 'U', U_V_V},
  {"vr_ntd2_5_hk",   'r', RTD_A2, 14, CAL32N(       1.274,           0.0), 'U', U_V_V},
  {"vr_still_6_hk",  'r', RTD_A2, 16, CAL32C(       1.148,           0.0), 'U', U_V_V},
  {"vr_mux_6_hk",    'r', RTD_A2, 18, CAL32C(       1.158,           0.0), 'U', U_V_V},
  {"vr_ntd1_6_hk",   'r', RTD_A2, 20, CAL32N(       1.269,           0.0), 'U', U_V_V},
  {"vr_fp_6_hk",     'r', RTD_A2, 22, CAL32C(       1.150,           0.0), 'U', U_V_V},
  {"vr_ssa_6_hk",    'r', RTD_A2, 24, CAL32C(       1.152,           0.0), 'U', U_V_V},
  {"vr_ntd4_6_hk",   'r', RTD_A2, 26, CAL32N(       1.267,           0.0), 'U', U_V_V},
  {"vr_ntd3_6_hk",   'r', RTD_A2, 28, CAL32N(       1.292,           0.0), 'U', U_V_V},
  {"vr_ntd2_6_hk",   'r', RTD_A2, 30, CAL32N(       1.278,           0.0), 'U', U_V_V},
  {"vr_still_4_hk",  'r', RTD_A2, 32, CAL32C(       1.148,           0.0), 'U', U_V_V},
  {"vr_mux_4_hk",    'r', RTD_A2, 34, CAL32C(       1.159,           0.0), 'U', U_V_V},
  {"vr_ntd1_4_hk",   'r', RTD_A2, 36, CAL32N(       1.276,           0.0), 'U', U_V_V},
  {"vr_fp_4_hk",     'r', RTD_A2, 38, CAL32C(       1.153,           0.0), 'U', U_V_V},
  {"vr_ssa_4_hk",    'r', RTD_A2, 40, CAL32C(       1.148,           0.0), 'U', U_V_V},
  {"vr_ntd4_4_hk",   'r', RTD_A2, 42, CAL32N(       1.283,           0.0), 'U', U_V_V},
  {"vr_ntd3_4_hk",   'r', RTD_A2, 44, CAL32N(       1.285,           0.0), 'U', U_V_V},
  {"vr_ntd2_4_hk",   'r', RTD_A2, 46, CAL32N(       1.276,           0.0), 'U', U_V_V},
  ...
  {"vd_01_4_hk",   'r', DIOD_A2,  2, CAL32D(         1.0,           0.0), 'U', U_V_V},
  ...
  {"vd_00_3_hk",   'r', DIOD_A2, 24, CAL32D(         1.0,           0.0), 'U', U_V_V},
