...
void FPrintDerived(FILE *fp) {
    fprintf(fp,
      ...
      "### ISC State Field ###\n"
      "ISC_SAVE_IMAGES  BIT isc_state 1\n"
      "ISC_PAUSE        BIT isc_state 2\n"
      "ISC_ABORT        BIT isc_state 3\n"
      "ISC_AUTOFOCUS    BIT isc_state 4\n"
      "ISC_BRIGHT_STAR  BIT isc_state 5\n"
      "ISC_SHUTDOWN     BIT isc_state 6\n"
