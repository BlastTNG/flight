...
struct ChannelStruct SlowChList[N_SLOW][FAST_PER_SLOW] = {
  ...
  },
  {
    ...
    {"isc_sigma",    'w', LOOPBAK2, 0,         I2DEG,             0.0, 'u'},
  ...
  },
  {
    ...
    {"isc_rtol",     'w', LOOPBAK2,  9,           1.0,             0.0, 'u'},
    ...
    {"isc_mtol",     'w', LOOPBAK2, 16,           1.0,             0.0, 'u'},
    {"isc_qtol",     'w', LOOPBAK2, 17,           1.0,             0.0, 'u'},
  ...
  {
    {"blob0_flux",   'w', LOOPBAK2, 28,          32.0,             0.0, 'u'},
    {"blob1_flux",   'w', LOOPBAK2, 29,          32.0,             0.0, 'u'},
