...
struct ChannelStruct SlowChList[N_SLOW][FAST_PER_SLOW] = {
  ...
  },
  {
    ...
    {"spare3",       'r',  ACSN,  3,                1.0,             0.0, 'u'},
    {"spare5",       'r',  ACSN,  5,                1.0,             0.0, 'u'},
    {"spare7",       'r',  ACSN,  7,                1.0,             0.0, 'u'},
    {"spare9",       'r',  ACSN,  9,                1.0,             0.0, 'u'},
    {"spare11",      'r',  ACSN, 11,                1.0,             0.0, 'u'},
    {"spare13",      'r',  ACSN, 13,                1.0,             0.0, 'u'},
    {"spare15",      'r',  ACSN, 15,                1.0,             0.0, 'u'},
    {"spare17",      'r',  ACSN, 17,                1.0,             0.0, 'u'},
    {"spare19",      'r',  ACSN, 19,                1.0,             0.0, 'u'},
    {"spare21",      'r',  ACSN, 21,                1.0,             0.0, 'u'},
    {"spare23",      'r',  ACSN, 23,                1.0,             0.0, 'u'},
    {"spare25",      'r',  ACSN, 25,                1.0,             0.0, 'u'},
    {"spare27",      'r',  ACSN, 27,                1.0,             0.0, 'u'},
    {"spare29",      'r',  ACSN, 29,                1.0,             0.0, 'u'},
    {"spare31",      'r',  ACSN, 31,                1.0,             0.0, 'u'},
    {"spare33",      'r',  ACSN, 33,                1.0,             0.0, 'u'},
    {"spare41",      'r',  ACSN, 41,                1.0,             0.0, 'u'}
  }
}; 
...
struct ChannelStruct FastChList[N_FASTCHLIST] = {
  ...
  {"roll_clin_sip",'r', ACS0, 27,   4.0/5333.3333,              -4.*6.144, 'u'},
  {"pch_clin_sip",'r',  ACS0, 29,   4.0/5333.3333,              -4.*6.144, 'u'},

  {"xel_clin_if", 'r',  ACS0, 37,      0.00546739,             -25.*6.144, 'u'},
  {"clin_elev",   'r',  ACS0, 39,      0.00546739,                 -135.5, 'u'},
