...
union DerivedUnion DerivedChannels[] = {
  ...
  LINCOM2("DR_INFO_IO_RW","DR_INFO_OPEN_RW",1,0,"DR_INFO_INIT_1_RW",10,0),
  LINCOM2("DR_INFO_RIO_RW","DR_INFO_RESET_RW",100,0,"DR_INFO_IO_RW",1,0),
  ...
  LINCOM2("DR_INFO_IO_EL","DR_INFO_OPEN_EL",1,0,"DR_INFO_INIT_1_EL",10,0),
  LINCOM2("DR_INFO_RIO_EL","DR_INFO_RESET_EL",100,0,"DR_INFO_IO_EL",1,0),
  ...
  LINCOM2("DR_INFO_IO_PIV","DR_INFO_OPEN_PIV",1,0,"DR_INFO_INIT_1_PIV",10,0),
  LINCOM2("DR_INFO_RIO_PIV","DR_INFO_RESET_PIV",100,0,"DR_INFO_IO_PIV",1,0),
  BITFIELD("fault_el",
	   "ST_F_CRC_EL",
