...
void catalogue( double ra_0, double dec_0, double radius, double mag_0, 
  ...
  std::list<Star> star = __astro_catalog->find( bigSearch );
  std::list<Star>::iterator it;        
  __astro_ncat = (int)star.size();
          ...
          for( k=0; k<2; k++ ) { // second time swap primary/secondary
            ...
            if( (var < sig_tol_squared) && 
              ...
              for( l=0; l<nblobs; l++ ) {
                ...
                //printf("(x,y)=%lf %lf, (blobx,bloby)=%lf %lf plate=%lf cos_theta=%lf sin_theta=%lf\n",
				//	x[l],y[l],blob_az_off[l],blob_el_off[l],
