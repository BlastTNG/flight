...
#define CONVERSIONS_ANGLE_M ((4.0*M_PI/2.0)/NARROW_MAX)
#define CONVERSIONS_ANGLE_B (-M_PI/2.0)
#define CONVERSIONS_WIDE_ANGLE_M ((4.0*M_PI/2.0)/WIDE_MAX)
#define CONVERSIONS_WIDE_ANGLE_B (-M_PI/2.0)
#define CONVERSIONS_ANGLE_DEGREES_M ((4.0*180.0/2.0)/NARROW_MAX)
