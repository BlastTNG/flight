...
#ifndef INCLUDE_CONVERSIONS_H_
#define INCLUDE_CONVERSIONS_H_

#include <time.h>
#include <math.h>

#define RX_CONVERT(TYPE, VAL) ((VAL) * CONVERSIONS_##TYPE##_M + CONVERSIONS_##TYPE##_B)
#define TX_CONVERT(TYPE, VAL) (((VAL) - CONVERSIONS_##TYPE##_B) / CONVERSIONS_##TYPE##_M)

#define CONVERSIONS_TEMP_C_M (473.15/65535.0)
#define CONVERSIONS_TEMP_C_B (-273.15)
#define CONVERSIONS_36V_M (72.0/65535.0)
#define CONVERSIONS_36V_B (-36.0)

#define NARROW_MAX (65535.0)
#define WIDE_MAX (4294967295.0)
#define CONVERSIONS_MICROSECONDS_M (1000000.0/NARROW_MAX)
#define CONVERSIONS_MICROSECONDS_B (0.0)
#define CONVERSIONS_VELOCITY_M (200.0/NARROW_MAX)
#define CONVERSIONS_VELOCITY_B (-100.0)
#define CONVERSIONS_TEMPERATURE_M (473.15/NARROW_MAX)
#define CONVERSIONS_TEMPERATURE_B (-273.15)
#define CONVERSIONS_PRESSURE_M (5.0/NARROW_MAX)
#define CONVERSIONS_PRESSURE_B (0.0)
#define CONVERSIONS_DISK_SPACE_GB_M (2000.0/NARROW_MAX)
#define CONVERSIONS_DISK_SPACE_GB_B (0.0)
#define CONVERSIONS_DISK_SPACE_TB_M (20000.0/NARROW_MAX)
#define CONVERSIONS_DISK_SPACE_TB_B (0.0)
#define CONVERSIONS_ANGLE_M ((5.0*M_PI/2.0)/NARROW_MAX)
#define CONVERSIONS_ANGLE_B (-M_PI/2.0)
#define CONVERSIONS_WIDE_ANGLE_M ((5.0*M_PI/2.0)/WIDE_MAX)
#define CONVERSIONS_WIDE_ANGLE_B (-M_PI/2.0)
#define CONVERSIONS_ANGLE_DEGREES_M ((5.0*180.0/2.0)/NARROW_MAX)
#define CONVERSIONS_ANGLE_DEGREES_B (-180.0/2.0)
#define CONVERSIONS_BLOB_POS_M (1536.0/NARROW_MAX)
#define CONVERSIONS_BLOB_POS_B (-768.0)
#define CONVERSIONS_FEW_SECONDS_M (300.0/NARROW_MAX)
#define CONVERSIONS_FEW_SECONDS_B (0.0)
#define CONVERSIONS_0_TO_10_M (10.0/NARROW_MAX)
#define CONVERSIONS_0_TO_10_B (0.0)
#define CONVERSIONS_0_TO_20_M (20.0/NARROW_MAX)
#define CONVERSIONS_0_TO_20_B (0.0)
#define CONVERSIONS_BATTV_M (100.0/NARROW_MAX)
#define CONVERSIONS_BATTV_B (0.0)
#define CONVERSIONS_BATTI_M (200.0/NARROW_MAX)
#define CONVERSIONS_BATTI_B (-100.0)
...
#define ARCMIN2RAD      (DEG2RAD/60.0) /* DEG2RAD/60. */ //BUGGY??
...
#define CONVERSIONS_SIDSLOPE_M (2000.0/NARROW_MAX) /*(NARROW_MAX/2000.0)*/
#define CONVERSIONS_SIDSLOPE_B 0
#define CONVERSIONS_GRTSLOPE_M (-30.0/NARROW_MAX) /*(NARROW_MAX/30.0)*/
#define CONVERSIONS_GRTSLOPE_B 0
