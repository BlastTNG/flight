...
blastcmd @192.168.1.3 xsc_exposure_timing 0 12 5 200
blastcmd @192.168.1.3 xsc_exposure_timing 1 12 5 200

# xsc_solver_general which enabled timeout_s
blastcmd @192.168.1.3 xsc_solver_general 0 1 4
blastcmd @192.168.1.3 xsc_solver_general 1 1 4
...
blastcmd @192.168.1.3 xsc_filter_hor_location 0 1 10
blastcmd @192.168.1.3 xsc_filter_hor_location 1 1 10
...
blastcmd @192.168.1.3 xsc_filter_hor_roll 0 1 -170 -165
blastcmd @192.168.1.3 xsc_filter_hor_roll 1 1 -100 -96

#  xsc_filter_el which enabled min_deg max_deg
blastcmd @192.168.1.3 xsc_filter_el 0 1 5 50
blastcmd @192.168.1.3 xsc_filter_el 1 1 5 50

# xsc_blob_finding which snr_thresh max_num_blobs robust_mode_enabled fitting_method
blastcmd @192.168.1.3 xsc_blob_finding 0 10 15 0 0
blastcmd @192.168.1.3 xsc_blob_finding 1 10 15 0 0
...
blastcmd @192.168.1.3 xsc_filter_matching 0 6 10 4
blastcmd @192.168.1.3 xsc_filter_matching 1 6 10 4
