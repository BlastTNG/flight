...
derived_tng_t derived_list[] = {
  ...
  BITWORD("STATUS_SBSC_ETH", "status_eth", 6, 2),
    ...
    BITWORD("ACT1_USED_ACTBUS", "used_actbus", 1, 1),
    BITWORD("ACT2_USED_ACTBUS", "used_actbus", 2, 1),
    BITWORD("BAL_USED_ACTBUS", "used_actbus", 3, 1),
    BITWORD("LOCK_USED_ACTBUS", "used_actbus", 4, 1),
    BITWORD("HWPR_USED_ACTBUS", "used_actbus", 5, 1),
    BITWORD("SHUTTER_USED_ACTBUS", "used_actbus", 6, 1),
    BITWORD("PUMPED_POT_USED_ACTBUS", "used_actbus", 7, 1),
    BITWORD("PUMP_VALVE_USED_ACTBUS", "used_actbus", 8, 1),
    BITWORD("FILL_VALVE_USED_ACTBUS", "used_actbus", 9, 1),
