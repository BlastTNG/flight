...
//  /* HWPR Control Info */
  ...
  COMMENT("ROXes"), // raw calibration only -- warning!
    ...
    LINTERP("Tt_roach2_fpga", "THERMISTOR_63", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach5_fpga", "THERMISTOR_64", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach4_fpga", "THERMISTOR_65", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach1_fpga", "THERMISTOR_66", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach3_fpga", "THERMISTOR_67", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach4_ppc", "THERMISTOR_68", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach1_ppc", "THERMISTOR_69", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach3_ppc", "THERMISTOR_70", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach2_ppc", "THERMISTOR_71", LUT_DIR "thermistor.lut"),
    LINTERP("Tt_roach5_ppc", "THERMISTOR_72", LUT_DIR "thermistor.lut"),
