...
// corrected temps?
    ...
    BITWORD("HAS_REF_ROACH1", "status_roach1", 9, 1),
    BITWORD("RETUNE_FLAG_ROACH1", "status_roach1", 10, 1),
    BITWORD("HAS_VNA_TONES_ROACH1", "status_roach1", 11, 1),
    BITWORD("TONE_FINDING_ERROR_ROACH1", "status_roach1", 12, 1),
    BITWORD("SWEEP_FAIL_ROACH1", "status_roach1", 13, 1),
    BITWORD("TONE_WRITE_FAIL_ROACH1", "status_roach1", 14, 1),
    BITWORD("FIRMWARE_UPLOAD_FAIL_ROACH1", "status_roach1", 15, 1),
    BITWORD("HAS_FIRMWARE_ROACH1", "status_roach1", 16, 1),
    BITWORD("LAMP_CHECK_ERROR_ROACH1", "status_roach1", 17, 1),
    BITWORD("KATCP_CONNECT_ERROR_ROACH1", "status_roach1", 18, 1),
    BITWORD("FRIDGE_CYCLE_WARNING_ROACH1", "status_roach1", 19, 1),
    BITWORD("PI_ERROR_COUNT_ROACH1", "status_roach1", 20, 1),
    BITWORD("DOING_FULL_LOOP_ROACH1", "status_roach1", 21, 1),
    BITWORD("DOING_FIND_KIDS_LOOP_ROACH1", "status_roach1", 22, 1),
    BITWORD("IS_FINDING_KIDS_ROACH1", "status_roach1", 23, 1),
    ...
    BITWORD("HAS_REF_ROACH2", "status_roach2", 9, 1),
    BITWORD("RETUNE_FLAG_ROACH2", "status_roach2", 10, 1),
    BITWORD("HAS_VNA_TONES_ROACH2", "status_roach2", 11, 1),
    BITWORD("TONE_FINDING_ERROR_ROACH2", "status_roach2", 12, 1),
    BITWORD("SWEEP_FAIL_ROACH2", "status_roach2", 13, 1),
    BITWORD("TONE_WRITE_FAIL_ROACH2", "status_roach2", 14, 1),
    BITWORD("FIRMWARE_UPLOAD_FAIL_ROACH2", "status_roach2", 15, 1),
    BITWORD("HAS_FIRMWARE_ROACH2", "status_roach2", 16, 1),
    BITWORD("LAMP_CHECK_ERROR_ROACH2", "status_roach2", 17, 1),
    BITWORD("KATCP_CONNECT_ERROR_ROACH2", "status_roach2", 18, 1),
    BITWORD("FRIDGE_CYCLE_WARNING_ROACH2", "status_roach2", 19, 1),
    BITWORD("PI_ERROR_COUNT_ROACH2", "status_roach2", 20, 1),
    BITWORD("DOING_FULL_LOOP_ROACH2", "status_roach2", 21, 1),
    BITWORD("DOING_FIND_KIDS_LOOP_ROACH2", "status_roach2", 22, 1),
    BITWORD("IS_FINDING_KIDS_ROACH2", "status_roach2", 23, 1),
    ...
    BITWORD("HAS_REF_ROACH3", "status_roach3", 9, 1),
    BITWORD("RETUNE_FLAG_ROACH3", "status_roach3", 10, 1),
    BITWORD("HAS_VNA_TONES_ROACH3", "status_roach3", 11, 1),
    BITWORD("TONE_FINDING_ERROR_ROACH3", "status_roach3", 12, 1),
    BITWORD("SWEEP_FAIL_ROACH3", "status_roach3", 13, 1),
    BITWORD("TONE_WRITE_FAIL_ROACH3", "status_roach3", 14, 1),
    BITWORD("FIRMWARE_UPLOAD_FAIL_ROACH3", "status_roach3", 15, 1),
    BITWORD("HAS_FIRMWARE_ROACH3", "status_roach3", 16, 1),
    BITWORD("LAMP_CHECK_ERROR_ROACH3", "status_roach3", 17, 1),
    BITWORD("KATCP_CONNECT_ERROR_ROACH3", "status_roach3", 18, 1),
    BITWORD("FRIDGE_CYCLE_WARNING_ROACH3", "status_roach3", 19, 1),
    BITWORD("PI_ERROR_COUNT_ROACH3", "status_roach3", 20, 1),
    BITWORD("DOING_FULL_LOOP_ROACH3", "status_roach3", 21, 1),
    BITWORD("DOING_FIND_KIDS_LOOP_ROACH3", "status_roach3", 22, 1),
    BITWORD("IS_FINDING_KIDS_ROACH3", "status_roach3", 23, 1),
    ...
    BITWORD("HAS_REF_ROACH4", "status_roach4", 9, 1),
    BITWORD("RETUNE_FLAG_ROACH4", "status_roach4", 10, 1),
    BITWORD("HAS_VNA_TONES_ROACH4", "status_roach4", 11, 1),
    BITWORD("TONE_FINDING_ERROR_ROACH4", "status_roach4", 12, 1),
    BITWORD("SWEEP_FAIL_ROACH4", "status_roach4", 13, 1),
    BITWORD("TONE_WRITE_FAIL_ROACH4", "status_roach4", 14, 1),
    BITWORD("FIRMWARE_UPLOAD_FAIL_ROACH4", "status_roach4", 15, 1),
    BITWORD("HAS_FIRMWARE_ROACH4", "status_roach4", 16, 1),
    BITWORD("LAMP_CHECK_ERROR_ROACH4", "status_roach4", 17, 1),
    BITWORD("KATCP_CONNECT_ERROR_ROACH4", "status_roach4", 18, 1),
    BITWORD("FRIDGE_CYCLE_WARNING_ROACH4", "status_roach4", 19, 1),
    BITWORD("PI_ERROR_COUNT_ROACH4", "status_roach4", 20, 1),
    BITWORD("DOING_FULL_LOOP_ROACH4", "status_roach4", 21, 1),
    BITWORD("DOING_FIND_KIDS_LOOP_ROACH4", "status_roach4", 22, 1),
    BITWORD("IS_FINDING_KIDS_ROACH4", "status_roach4", 23, 1),
    ...
    BITWORD("HAS_REF_ROACH5", "status_roach5", 9, 1),
    BITWORD("RETUNE_FLAG_ROACH5", "status_roach5", 10, 1),
    BITWORD("HAS_VNA_TONES_ROACH5", "status_roach5", 11, 1),
    BITWORD("TONE_FINDING_ERROR_ROACH5", "status_roach5", 12, 1),
    BITWORD("SWEEP_FAIL_ROACH5", "status_roach5", 13, 1),
    BITWORD("TONE_WRITE_FAIL_ROACH5", "status_roach5", 14, 1),
    BITWORD("FIRMWARE_UPLOAD_FAIL_ROACH5", "status_roach5", 15, 1),
    BITWORD("HAS_FIRMWARE_ROACH5", "status_roach5", 16, 1),
    BITWORD("LAMP_CHECK_ERROR_ROACH5", "status_roach5", 17, 1),
    BITWORD("KATCP_CONNECT_ERROR_ROACH5", "status_roach5", 18, 1),
    BITWORD("FRIDGE_CYCLE_WARNING_ROACH5", "status_roach5", 19, 1),
    BITWORD("PI_ERROR_COUNT_ROACH5", "status_roach5", 20, 1),
    BITWORD("DOING_FULL_LOOP_ROACH5", "status_roach5", 21, 1),
    BITWORD("DOING_FIND_KIDS_LOOP_ROACH5", "status_roach5", 22, 1),
    BITWORD("IS_FINDING_KIDS_ROACH5", "status_roach5", 23, 1),
    ...
    LINTERP("Tt_if_power", "Rt_therm11", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_if_lj", "Rt_therm12", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_rec", "Rt_therm13", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_rec_power", "Rt_therm14", LUT_DIR "Thermistor_RtoT.lut"),
    ...
    LINTERP("Tt_gyro_1", "Rt_therm18", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_gyro_2", "Rt_therm19", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_balance_sys", "Rt_therm20", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_ob_back_1", "Rt_therm21", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_ob_back_2", "Rt_therm22", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_ob_front_1", "Rt_therm23", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_ob_front_2", "Rt_therm24", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_strut_1a", "Rt_therm25", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_strut_1b", "Rt_therm26", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_strut_2", "Rt_therm27", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_dead", "Rt_therm28", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_m1_back_2", "Rt_therm29", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_if_eth_switch", "Rt_therm30", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_m1_front_inner", "Rt_therm31", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_of_front", "Rt_therm32", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_of_port", "Rt_therm33", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_el_motor", "Rt_therm34", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_lock_motor", "Rt_therm35", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_acs_box", "Rt_therm36", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_fc1", "Rt_therm37", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_battery_1", "Rt_therm38", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_battery_3", "Rt_therm39", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_hdd_1", "Rt_therm40", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_solar_1_tl", "Rt_therm41", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_solar_2_tl", "Rt_therm42", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_sun_shield_rear", "Rt_therm43", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_sun_shield_chin", "Rt_therm44", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_of_back", "Rt_therm45", LUT_DIR "Thermistor_RtoT.lut"),
    ...
    LINTERP("Tt_fc2", "Rt_therm50", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_battery_2", "Rt_therm51", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_battery_4", "Rt_therm52", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_m1_back_1", "Rt_therm53", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_solar_1_br", "Rt_therm54", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_solar_2_br", "Rt_therm55", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_pivot", "Rt_therm56", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_m1_front_outer_1", "Rt_therm57", LUT_DIR "Thermistor_RtoT.lut"),
