...
//      ),
  ...
  /* Secondary Focus */
    ...
    BITWORD("NET_ST_NODE_STATUS_PIV", "network_status_pivot", 0, 2),
    BITWORD("NET_ST_SYNC_MISSING_PIV", "network_status_pivot", 4, 1),
    BITWORD("NET_ST_GUARD_ERR_PIV", "network_status_pivot", 5, 1),
    BITWORD("NET_ST_BUS_OFF_PIV", "network_status_pivot", 8, 1),
    BITWORD("NET_ST_SYNC_TRANS_ERROR_PIV", "network_status_pivot", 9, 1),
    BITWORD("NET_ST_SYNC_REC_ERROR_PIV", "network_status_pivot", 10, 1),
    BITWORD("NET_ST_SYNC_TRANS_WARNING_PIVOT", "network_status_pivot", 11, 1),
    BITWORD("NET_ST_SYNC_REC_WARNING_PIVOT", "network_status_pivot", 12, 1),
