...
//  /* HWPR Control Info */
  ...
  COMMENT("Diodes"),
    LINCOM("TD_CHARCOAL_HS_INT", "TD_CHARCOAL_HS", 0.199698, 0.035979),
    LINCOM("TD_VCS2_FILT_INT", "TD_VCS2_FILT", 0.200142, 0.027770),
    LINCOM("TD_250FPA_INT", "TD_250FPA", 0.198790, 0.043033),
    LINCOM("TD_HWP_INT", "TD_HWP", 0.192990, 0.065234),
    LINCOM("TD_VCS1_HX_INT", "TD_VCS1_HX", 0.191448, 0.068257),
    LINCOM("TD_1K_FRIDGE_INT", "TD_1K_FRIDGE", 0.200080, 0.035373),
    LINCOM("TD_4K_plate_INT", "TD_4K_PLATE", 0.202283, -0.001608),
    LINCOM("TD_VCS1_FILT_INT", "TD_VCS1_FILT", 0.201881, 0.023854),
    LINCOM("TD_M3_INT", "TD_M3", 0.200289, 0.032317),
    LINCOM("TD_CHARCOAL_INT", "TD_CHARCOAL", 0.200652, 0.025044),
    LINCOM("TD_OB_FILTER_INT", "TD_OB_FILTER", 0.200460, 0.037968),
    LINCOM("TD_VCS2_PLATE_INT", "TD_VCS2_PLATE", 0.203749, 0.022869),
    LINCOM("TD_M4_INT", "TD_M4", 0.198817, 0.037437),
    LINCOM("TD_4K_FILT_INT", "TD_4K_FILT", 0.182920, 0.104300),
    LINCOM("TD_VCS2_HX_INT", "TD_VCS2_HX", 0.198847, 0.041923),
    LINCOM("TD_VCS1_PLATE_INT", "TD_VCS1_PLATE", 0.182072, 0.108255),
  ...
  LINTERP("Tr_1k_plate", "TR_1K_PLATE_INT", LUT_DIR "rox-raw.txt"),
    UNITS("Tr_1k_plate", "Temperature", "K"),
  LINTERP("Tr_300mk_strap", "TR_300MK_STRAP_INT", LUT_DIR "rox-raw.txt"),
    UNITS("Tr_300mk_strap", "Temperature", "K"),
  LINTERP("Tr_350_fpa",   "TR_350_FPA_INT"   , LUT_DIR "rox-raw.txt"),
    UNITS("Tr_350_fpa", "Temperature", "K"),
  LINTERP("Tr_he4_pot",   "TR_HE4_POT_INT"   , LUT_DIR "rox-raw.txt"),
    UNITS("Tr_he4_pot", "Temperature", "K"),
  LINTERP("Tr_he3_fridge",    "TR_HE3_FRIDGE_INT"    , LUT_DIR "rox-raw.txt"),
    UNITS("Tr_he3_fridge", "Temperature", "K"),
  LINTERP("Tr_500_fpa", "TR_500_FPA_INT", LUT_DIR "rox-raw.txt"),
