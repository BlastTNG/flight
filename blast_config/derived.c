...
derived_tng_t derived_list[] = {
  ...
  BITWORD("STATUS_SBSC_ETH", "status_eth", 6, 2),
    ...
    BITWORD("OK_EL_MOTOR_ENC", "ok_sensor", 0, 1),
    BITWORD("OK_DGPS", "ok_sensor", 1, 1),
    BITWORD("OK_POINT_PSS", "ok_sensor", 2, 1),
    BITWORD("OK_MAG1", "ok_sensor", 3, 1),
    BITWORD("OK_MAG2", "ok_sensor", 4, 1),
...
// corrected temps?
    ...
    // Roach Channels
    BITWORD("HAS_ERROR_ROACH1", "status_roach1", 0, 1),
    BITWORD("HAS_QDR_CAL_ROACH1", "status_roach1", 1, 1),
    BITWORD("HAS_TONES_ROACH1", "status_roach1", 2, 1),
    BITWORD("HAS_TARG_TONES_ROACH1", "status_roach1", 3, 1),
    BITWORD("IS_STREAMING_ROACH1", "status_roach1", 4, 1),
    BITWORD("IS_SWEEPING_ROACH1", "status_roach1", 5, 1),
    BITWORD("HAS_VNA_SWEEP_ROACH1", "status_roach1", 6, 1),
    BITWORD("HAS_TARG_SWEEP_ROACH1", "status_roach1", 7, 1),
    BITWORD("HAS_AMP_CAL_ROACH1", "status_roach1", 8, 1),
    BITWORD("HAS_ADC_CAL_ROACH1", "status_roach1", 9, 1),
    BITWORD("WRITE_FLAG_ROACH1", "status_roach1", 10, 1),
    BITWORD("HAS_REF_ROACH1", "status_roach1", 11, 1),
    BITWORD("RETUNE_FLAG_ROACH1", "status_roach1", 12, 1),
    BITWORD("HAS_VNA_TONES_ROACH1", "status_roach1", 13, 1),
    BITWORD("HAS_ERROR_ROACH2", "status_roach2", 0, 1),
    BITWORD("HAS_QDR_CAL_ROACH2", "status_roach2", 1, 1),
    BITWORD("HAS_TONES_ROACH2", "status_roach2", 2, 1),
    BITWORD("HAS_TARG_TONES_ROACH2", "status_roach2", 3, 1),
    BITWORD("IS_STREAMING_ROACH2", "status_roach2", 4, 1),
    BITWORD("IS_SWEEPING_ROACH2", "status_roach2", 5, 1),
    BITWORD("HAS_VNA_SWEEP_ROACH2", "status_roach2", 6, 1),
    BITWORD("HAS_TARG_SWEEP_ROACH2", "status_roach2", 7, 1),
    BITWORD("HAS_AMP_CAL_ROACH2", "status_roach2", 8, 1),
    BITWORD("HAS_ADC_CAL_ROACH2", "status_roach2", 9, 1),
    BITWORD("WRITE_FLAG_ROACH2", "status_roach2", 10, 1),
    BITWORD("HAS_REF_ROACH2", "status_roach2", 11, 1),
    BITWORD("RETUNE_FLAG_ROACH2", "status_roach2", 12, 1),
    BITWORD("HAS_VNA_TONES_ROACH2", "status_roach2", 13, 1),
    BITWORD("HAS_ERROR_ROACH3", "status_roach3", 0, 1),
    BITWORD("HAS_QDR_CAL_ROACH3", "status_roach3", 1, 1),
    BITWORD("HAS_TONES_ROACH3", "status_roach3", 2, 1),
    BITWORD("HAS_TARG_TONES_ROACH3", "status_roach3", 3, 1),
    BITWORD("IS_STREAMING_ROACH3", "status_roach3", 4, 1),
    BITWORD("IS_SWEEPING_ROACH3", "status_roach3", 5, 1),
    BITWORD("HAS_VNA_SWEEP_ROACH3", "status_roach3", 6, 1),
    BITWORD("HAS_TARG_SWEEP_ROACH3", "status_roach3", 7, 1),
    BITWORD("HAS_AMP_CAL_ROACH3", "status_roach3", 8, 1),
    BITWORD("HAS_ADC_CAL_ROACH3", "status_roach3", 9, 1),
    BITWORD("WRITE_FLAG_ROACH3", "status_roach3", 10, 1),
    BITWORD("HAS_REF_ROACH3", "status_roach3", 11, 1),
    BITWORD("RETUNE_FLAG_ROACH3", "status_roach3", 12, 1),
    BITWORD("HAS_VNA_TONES_ROACH3", "status_roach3", 13, 1),
    BITWORD("HAS_ERROR_ROACH4", "status_roach4", 0, 1),
    BITWORD("HAS_QDR_CAL_ROACH4", "status_roach4", 1, 1),
    BITWORD("HAS_TONES_ROACH4", "status_roach4", 2, 1),
    BITWORD("HAS_TARG_TONES_ROACH4", "status_roach4", 3, 1),
    BITWORD("IS_STREAMING_ROACH4", "status_roach4", 4, 1),
    BITWORD("IS_SWEEPING_ROACH4", "status_roach4", 5, 1),
    BITWORD("HAS_VNA_SWEEP_ROACH4", "status_roach4", 6, 1),
    BITWORD("HAS_TARG_SWEEP_ROACH4", "status_roach4", 7, 1),
    BITWORD("HAS_AMP_CAL_ROACH4", "status_roach4", 8, 1),
    BITWORD("HAS_ADC_CAL_ROACH4", "status_roach4", 9, 1),
    BITWORD("WRITE_FLAG_ROACH4", "status_roach4", 10, 1),
    BITWORD("HAS_REF_ROACH4", "status_roach4", 11, 1),
    BITWORD("RETUNE_FLAG_ROACH4", "status_roach4", 12, 1),
    BITWORD("HAS_VNA_TONES_ROACH4", "status_roach4", 13, 1),
    BITWORD("HAS_ERROR_ROACH5", "status_roach5", 0, 1),
    BITWORD("HAS_QDR_CAL_ROACH5", "status_roach5", 1, 1),
    BITWORD("HAS_TONES_ROACH5", "status_roach5", 2, 1),
    BITWORD("HAS_TARG_TONES_ROACH5", "status_roach5", 3, 1),
    BITWORD("IS_STREAMING_ROACH5", "status_roach5", 4, 1),
    BITWORD("IS_SWEEPING_ROACH5", "status_roach5", 5, 1),
    BITWORD("HAS_VNA_SWEEP_ROACH5", "status_roach5", 6, 1),
    BITWORD("HAS_TARG_SWEEP_ROACH5", "status_roach5", 7, 1),
    BITWORD("HAS_AMP_CAL_ROACH5", "status_roach5", 8, 1),
    BITWORD("HAS_ADC_CAL_ROACH5", "status_roach5", 9, 1),
    BITWORD("WRITE_FLAG_ROACH5", "status_roach5", 10, 1),
    BITWORD("HAS_REF_ROACH5", "status_roach5", 11, 1),
    BITWORD("RETUNE_FLAG_ROACH5", "status_roach5", 12, 1),
    BITWORD("HAS_VNA_TONES_ROACH5", "status_roach5", 13, 1),
    ...
    LINTERP("Tt_therm1", "Rt_therm1", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm2", "Rt_therm2", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm3", "Rt_therm3", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm4", "Rt_therm4", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm5", "Rt_therm5", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm6", "Rt_therm6", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm7", "Rt_therm7", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm8", "Rt_therm8", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm9", "Rt_therm9", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm10", "Rt_therm10", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm11", "Rt_therm11", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm12", "Rt_therm12", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm13", "Rt_therm13", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm14", "Rt_therm14", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm15", "Rt_therm15", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm16", "Rt_therm16", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm17", "Rt_therm17", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm18", "Rt_therm18", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm19", "Rt_therm19", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm20", "Rt_therm20", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm21", "Rt_therm21", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm22", "Rt_therm22", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm23", "Rt_therm23", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm24", "Rt_therm24", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm25", "Rt_therm25", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm26", "Rt_therm26", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm27", "Rt_therm27", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm28", "Rt_therm28", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm29", "Rt_therm29", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm30", "Rt_therm30", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm31", "Rt_therm31", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm32", "Rt_therm32", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm33", "Rt_therm33", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm34", "Rt_therm34", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm35", "Rt_therm35", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm36", "Rt_therm36", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm37", "Rt_therm37", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm38", "Rt_therm38", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm39", "Rt_therm39", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm40", "Rt_therm40", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm41", "Rt_therm41", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm42", "Rt_therm42", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm43", "Rt_therm43", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm44", "Rt_therm44", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm45", "Rt_therm45", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm46", "Rt_therm46", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm47", "Rt_therm47", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm48", "Rt_therm48", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm49", "Rt_therm49", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm50", "Rt_therm50", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm51", "Rt_therm51", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm52", "Rt_therm52", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm53", "Rt_therm53", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm54", "Rt_therm54", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm55", "Rt_therm55", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm56", "Rt_therm56", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm57", "Rt_therm57", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm58", "Rt_therm58", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm59", "Rt_therm59", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm60", "Rt_therm60", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm61", "Rt_therm61", LUT_DIR "Thermistor_RtoT.lut"),
    LINTERP("Tt_therm62", "Rt_therm62", LUT_DIR "Thermistor_RtoT.lut"),
