...
//  /* HWPR Control Info */
  ...
  COMMENT("ROXes"), // raw calibration only -- warning!
    LINCOM("TR_FPA_1K_INT", "TR_FPA_1K", .99875, 0.000693),
    LINCOM("TR_250_FPA_INT", "TR_250_FPA", .99989, 0.000876),
    LINCOM("TR_1K_PLATE_INT", "TR_1K_PLATE", .99877, 0.000520),
    LINCOM("TR_300MK_STRAP_INT", "TR_300MK_STRAP", .99886, 0.000549),
    LINCOM("TR_350_FPA_INT", "TR_350_FPA", .99881, 0.000423),
    LINCOM("TR_HE4_POT_INT", "TR_HE4_POT", 1.0044, 0.000842),
    LINCOM("TR_HE3_FRIDGE_INT", "TR_HE3_FRIDGE", .99886, 0.000664),
    LINCOM("TR_500_FPA_INT", "TR_500_FPA", .99888, 0.000520),
    LINCOM("ROX_BIAS_INT_LJ", "ROX_BIAS", -.99879, -0.000626),
    LINTERP("NOMINAL_BIAS", "ROX_BIAS_INT_LJ", LUT_DIR "Vbias_LUT.txt"),
    LINCOM("ROX_BIAS_COMPARE", "NOMINAL_BIAS", 62.5, 0),
    MULTIPLY("TR_FPA_1K_CORRECTED", "TR_FPA_1K_INT", "ROX_BIAS_COMPARE"),
    MULTIPLY("TR_250_FPA_CORRECTED", "TR_250_FPA_INT", "ROX_BIAS_COMPARE"),
    MULTIPLY("TR_1K_PLATE_CORRECTED", "TR_1K_PLATE_INT", "ROX_BIAS_COMPARE"),
    MULTIPLY("TR_300MK_STRAP_CORRECTED", "TR_300MK_STRAP_INT", "ROX_BIAS_COMPARE"),
    MULTIPLY("TR_350_FPA_CORRECTED", "TR_350_FPA_INT", "ROX_BIAS_COMPARE"),
    MULTIPLY("TR_HE4_POT_CORRECTED", "TR_HE4_POT_INT", "ROX_BIAS_COMPARE"),
    MULTIPLY("TR_HE3_FRIDGE_CORRECTED", "TR_HE3_FRIDGE_INT", "ROX_BIAS_COMPARE"),
    MULTIPLY("TR_500_FPA_CORRECTED", "TR_500_FPA_INT", "ROX_BIAS_COMPARE"),
    ...
    LINTERP("RR_HE4_POT", "TR_HE4_POT_CORRECTED", LUT_DIR "VR_LUT_he4po.txt"),
