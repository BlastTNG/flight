...
//  /* HWPR Control Info */
  ...
  COMMENT("Diodes"),
    ...
    LINCOM("TD_CHARCOAL_INT", "TD_CHARCOAL", 0.2, 0),
    LINCOM("TD_OB_FILTER_INT", "TD_OB_FILTER", 0.2, 0),
    LINCOM("TD_VCS2_PLATE_INT", "TD_VCS2_PLATE", 0.2, 0),
    LINCOM("TD_M4_INT", "TD_M4", 0.2, 0),
    LINCOM("TD_4K_FILT_INT", "TD_4K_FILT", 0.2, 0),
    LINCOM("TD_VCS2_HX_INT", "TD_VCS2_HX", 0.2, 0),
    LINCOM("TD_VCS1_PLATE_INT", "TD_VCS1_PLATE", 0.2, 0),
