...
//  /* HWPR Control Info */
  ...
  LINTERP("Tr_fpa_1k", "TR_FPA_1K", LUT_DIR "rox-raw.txt"),
    UNITS("Tr_fpa_1k", "Temperature", "K"),
  LINTERP("Tr_250_fpa", "TR_250_FPA" , LUT_DIR "rox-raw.txt"),
    UNITS("Tr_250_fpa", "Temperature", "K"),
  LINTERP("Tr_1k_plate", "TR_1K_PLATE", LUT_DIR "rox-raw.txt"),
  ...
  LINTERP("Tr_350_fpa",   "TR_350_FPA"   , LUT_DIR "rox-raw.txt"),
  ...
  LINTERP("Tr_500_fpa", "TR_500_FPA", LUT_DIR "rox-raw.txt"),
