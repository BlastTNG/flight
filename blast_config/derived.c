...
//      ),
  ...
  /* Secondary Focus */
    ...
    BITWORD("EC_UNKNOWN_EC_RW", "status_ec_rw", 5, 1),
    ...
    BITWORD("EC_UNKNOWN_EC_EL", "status_ec_el", 5, 1),
    ...
    BITWORD("EC_UNKNOWN_EC_PIV", "status_ec_piv", 5, 1),
...
// corrected temps?
    ...
    BITWORD("FRIDGE_CYCLE_WARNING_ROACH5", "status_roach4", 19, 1),
