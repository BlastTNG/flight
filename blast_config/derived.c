...
// corrected temps?
    ...
    BITWORD("PI_ERROR_COUNT_ROACH1", "status_roach1", 19, 1),
    ...
    BITWORD("PI_ERROR_COUNT_ROACH2", "status_roach2", 19, 1),
    ...
    BITWORD("PI_ERROR_COUNT_ROACH3", "status_roach3", 19, 1),
    ...
    BITWORD("PI_ERROR_COUNT_ROACH4", "status_roach4", 19, 1),
    ...
    BITWORD("PI_ERROR_COUNT_ROACH5", "status_roach5", 19, 1),
