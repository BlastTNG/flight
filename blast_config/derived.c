...
//  /* HWPR Control Info */
  ...
  COMMENT("ROXes"), // raw calibration only -- warning!
    // change the LINCOMs to LINTERPs once we get actual calibration data
    LINCOM("TR_FPA_1K_INT", "TR_FPA_1K", 1.00125, 0.000693),
    LINCOM("TR_250_FPA_INT", "TR_250_FPA", 1.00125, 0.000693),
    LINCOM("TR_1K_PLATE_INT", "TR_1K_PLATE", 1.00125, 0.000693),
    LINCOM("TR_300MK_STRAP_INT", "TR_300MK_STRAP", 1.00125, 0.000693),
    LINCOM("TR_350_FPA_INT", "TR_350_FPA", 1.00125, 0.000693),
    LINCOM("TR_HE4_POT_INT", "TR_HE4_POT", 1.00125, 0.000693),
    LINCOM("TR_HE3_FRIDGE_INT", "TR_HE3_FRIDGE", 1.00125, 0.000693),
    LINCOM("TR_500_FPA_INT", "TR_500_FPA", 1.00125, 0.000693),
