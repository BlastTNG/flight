...
//  /* HWPR Control Info */
  ...
  COMMENT("Diodes"),
    ...
    LINTERP("Td_1k_fridge", "TD_1K_FRIDGE", LUT_DIR "dt600.txt"),
    LINTERP("Td_4k_plate", "TD_4K_PLATE", LUT_DIR "dt600.txt"),
    ...
    LINTERP("Td_vcs2_plate", "TD_VCS2_PLATE", LUT_DIR "dt600.txt"),
    LINTERP("Td_m4", "TD_M4", LUT_DIR "dt600.txt"),
    LINTERP("Td_4k_filt", "TD_4K_FILT", LUT_DIR "dt600.txt"),
    LINTERP("Td_vcs2_hx", "TD_VCS2_HX", LUT_DIR "dt600.txt"),
    LINTERP("Td_vcs1_plate", "TD_VCS1_PLATE", LUT_DIR "dt600.txt"),
