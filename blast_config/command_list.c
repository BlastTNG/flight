...
// power box OF and IF relay controls
  ...
  {COMMAND(if_lj_cycle), "powercycling if labjacks", GR_POWER},
  {COMMAND(timing_dist_cycle), "powercycling timing dist box", GR_POWER},
  ...
  {COMMAND(if_eth_cycle), "powercycling if ethernet", GR_POWER},
  {COMMAND(if_8_cycle), "powercycling if relay 8", GR_POWER},
  {COMMAND(roach_cycle), "powercycling roaches", GR_POWER},
  {COMMAND(cryo_hk_cycle), "powercycling cryo HK", GR_POWER},
  {COMMAND(if_relay_1_on), "turning on IF relay 1", GR_POWER},
  {COMMAND(if_lj_on), "turning on IF labjacks", GR_POWER},
  {COMMAND(timing_dist_on), "turning on timing dist box", GR_POWER},
  ...
  {COMMAND(if_eth_on), "turning on IF ethernet", GR_POWER},
  {COMMAND(if_relay_8_on), "turning on IF relay 8", GR_POWER},
  {COMMAND(roach_on), "turning on roaches", GR_POWER},
  {COMMAND(cryo_hk_on), "turning on cryo HK", GR_POWER},
  {COMMAND(if_relay_1_off), "turning off IF relay 1", GR_POWER},
  {COMMAND(if_lj_off), "turning off IF Labjacks", GR_POWER},
  {COMMAND(timing_dist_off), "turning off timing dist box", GR_POWER},
  ...
  {COMMAND(if_eth_off), "turning off IF ethernet", GR_POWER},
  {COMMAND(if_relay_8_off), "turning off IF relay 8", GR_POWER},
  {COMMAND(roach_off), "turning off roaches", GR_POWER},
  {COMMAND(cryo_hk_off), "turning off cryo HK", GR_POWER},
