...
struct scom scommands[xyzzy + 1] = {
  ...
  {COMMAND(switch_5V_on), "turning on 5V channels", GR_CRYO},
  {COMMAND(switch_5V_off), "turning off 5V channels", GR_CRYO},
  {COMMAND(switch_12V_on), "turning on 12V channels", GR_CRYO},
  {COMMAND(switch_12V_off), "turning off 12V channels", GR_CRYO},
  {COMMAND(switch_15V_on), "turning on 15V channels", GR_CRYO},
  {COMMAND(switch_15V_off), "turning off 15V channels", GR_CRYO},
  {COMMAND(switch_40V_on), "turning on 40V channels", GR_CRYO},
  {COMMAND(switch_40V_off), "turning off 40V channels", GR_CRYO},
