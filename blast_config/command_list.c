...
struct scom scommands[xyzzy + 1] = {
  ...
  {COMMAND(reboot_ljcryo1), "rebooting labjack cryo 1", GR_LJPOWER},
...
// power box OF and IF relay controls
  {COMMAND(cycle_hd_pv), "powercycling HD PV", GR_LJPOWER},
  {COMMAND(cycle_eth_switch), "powercycling Eth Switch", GR_LJPOWER},
  {COMMAND(cycle_fc1), "powercycling FC1", GR_LJPOWER},
  {COMMAND(cycle_xsc1), "powercycling XSC1", GR_LJPOWER},
  {COMMAND(cycle_fc2), "powercycling FC2", GR_LJPOWER},
  {COMMAND(cycle_xsc0), "powercycling XSC0", GR_LJPOWER},
  {COMMAND(cycle_gyros), "powercycling gyros", GR_LJPOWER},
  {COMMAND(cycle_data_transmit), "powercycling Data Transmit", GR_LJPOWER},
  {COMMAND(cycle_el_mot), "powercycling El Motor", GR_LJPOWER},
  {COMMAND(cycle_pivot), "powercycling pivot", GR_LJPOWER},
  {COMMAND(cycle_magnetometer), "powercycling magnetometer", GR_LJPOWER},
  {COMMAND(cycle_rw_mot), "powercycling RW Motor", GR_LJPOWER},
  {COMMAND(cycle_steppers), "powercycling steppers", GR_LJPOWER},
  {COMMAND(cycle_clinometers), "powercycling clinometers", GR_LJPOWER},
  {COMMAND(cycle_of_15), "powercycling OF relay 15", GR_LJPOWER},
  {COMMAND(cycle_gps_timing), "powercycling gps timing", GR_LJPOWER},
  {COMMAND(hd_pv_on), "turning on HD PV", GR_LJPOWER},
  {COMMAND(eth_switch_on), "turning on Eth Switch", GR_LJPOWER},
  {COMMAND(fc1_on), "turning on FC1", GR_LJPOWER},
  {COMMAND(xsc1_acs_on), "turning on XSC1", GR_LJPOWER},
  {COMMAND(fc2_on), "turning on FC2", GR_LJPOWER},
  {COMMAND(xsc0_acs_on), "turning on XSC0", GR_LJPOWER},
  {COMMAND(gyros_on), "turning on OF gyros", GR_LJPOWER},
  {COMMAND(data_transmit_on), "turning on Data Transmit", GR_LJPOWER},
  {COMMAND(el_mot_on), "turning on El Motor", GR_LJPOWER},
  {COMMAND(pivot_on), "turning on pivot", GR_LJPOWER},
  {COMMAND(magnetometer_on), "turning on magnetometer", GR_LJPOWER},
  {COMMAND(rw_mot_on), "turning on RW Motor", GR_LJPOWER},
  {COMMAND(steppers_on), "turning on steppers", GR_LJPOWER},
  {COMMAND(clinometers_on), "turning on clinometers", GR_LJPOWER},
  {COMMAND(of_relay_15_on), "turning on OF relay 15", GR_LJPOWER},
  {COMMAND(gps_timing_on), "turning on gps timing", GR_LJPOWER},
  {COMMAND(hd_pv_off), "turning off HD PV", GR_LJPOWER},
  {COMMAND(eth_switch_off), "turning off Eth Switch", GR_LJPOWER},
  {COMMAND(fc1_off), "turning off FC1", GR_LJPOWER},
  {COMMAND(xsc1_acs_off), "turning off XSC1", GR_LJPOWER},
  {COMMAND(fc2_off), "turning off FC2", GR_LJPOWER},
  {COMMAND(xsc0_acs_off), "turning off XSC0", GR_LJPOWER},
  {COMMAND(gyros_off), "turning off OF gyros", GR_LJPOWER},
  {COMMAND(data_transmit_off), "turning off Data Transmit", GR_LJPOWER},
  {COMMAND(el_mot_off), "turning off El Motor", GR_LJPOWER},
  {COMMAND(pivot_off), "turning off pivot", GR_LJPOWER},
  {COMMAND(magnetometer_off), "turning off magnetometer", GR_LJPOWER},
  {COMMAND(rw_mot_off), "turning off RW Motor", GR_LJPOWER},
  {COMMAND(steppers_off), "turning off steppers", GR_LJPOWER},
  {COMMAND(clinometers_off), "turning off clinometers", GR_LJPOWER},
  {COMMAND(of_relay_15_off), "turning off OF relay 15", GR_LJPOWER},
  {COMMAND(gps_timing_off), "turning off gps timing", GR_LJPOWER},
  {COMMAND(cycle_if_1), "powercycling if relay 1", GR_LJPOWER},
  {COMMAND(cycle_if_2), "powercycling if relay 2", GR_LJPOWER},
  {COMMAND(cycle_if_3), "powercycling if relay 3", GR_LJPOWER},
  {COMMAND(cycle_if_4), "powercycling if relay 4", GR_LJPOWER},
  {COMMAND(cycle_if_5), "powercycling if relay 5", GR_LJPOWER},
  {COMMAND(cycle_if_6), "powercycling if relay 6", GR_LJPOWER},
  {COMMAND(cycle_if_7), "powercycling if relay 7", GR_LJPOWER},
  {COMMAND(cycle_if_8), "powercycling if relay 8", GR_LJPOWER},
  {COMMAND(cycle_if_9), "powercycling if relay 9", GR_LJPOWER},
  {COMMAND(cycle_if_10), "powercycling if relay 10", GR_LJPOWER},
  {COMMAND(if_relay_1_on), "turning on IF relay 1", GR_LJPOWER},
  {COMMAND(if_relay_2_on), "turning on IF relay 2", GR_LJPOWER},
  {COMMAND(if_relay_3_on), "turning on IF relay 3", GR_LJPOWER},
  {COMMAND(if_relay_4_on), "turning on IF relay 4", GR_LJPOWER},
  {COMMAND(if_relay_5_on), "turning on IF relay 5", GR_LJPOWER},
  {COMMAND(if_relay_6_on), "turning on IF relay 6", GR_LJPOWER},
  {COMMAND(if_relay_7_on), "turning on IF relay 7", GR_LJPOWER},
  {COMMAND(if_relay_8_on), "turning on IF relay 8", GR_LJPOWER},
  {COMMAND(if_relay_9_on), "turning on IF relay 9", GR_LJPOWER},
  {COMMAND(if_relay_10_on), "turning on IF relay 10", GR_LJPOWER},
  {COMMAND(if_relay_1_off), "turning off IF relay 1", GR_LJPOWER},
  {COMMAND(if_relay_2_off), "turning off IF relay 2", GR_LJPOWER},
  {COMMAND(if_relay_3_off), "turning off IF relay 3", GR_LJPOWER},
  {COMMAND(if_relay_4_off), "turning off IF relay 4", GR_LJPOWER},
  {COMMAND(if_relay_5_off), "turning off IF relay 5", GR_LJPOWER},
  {COMMAND(if_relay_6_off), "turning off IF relay 6", GR_LJPOWER},
  {COMMAND(if_relay_7_off), "turning off IF relay 7", GR_LJPOWER},
  {COMMAND(if_relay_8_off), "turning off IF relay 8", GR_LJPOWER},
  {COMMAND(if_relay_9_off), "turning off IF relay 9", GR_LJPOWER},
  {COMMAND(if_relay_10_off), "turning off IF relay 10", GR_LJPOWER},
