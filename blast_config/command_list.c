...
// power box OF and IF relay controls
  ...
  {COMMAND(if_1_cycle), "powercycling if relay 1", GR_POWER | CONFIRM},
  ...
  {COMMAND(if_relay_1_on), "turning on IF relay 1", GR_POWER | CONFIRM},
  ...
  {COMMAND(if_relay_1_off), "turning off IF relay 1", GR_POWER | CONFIRM},
