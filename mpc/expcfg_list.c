...
const struct cfg_serial expcfg_list[] = {
  ...
  {"sq1_ramp_bias_ramp", CFGSER_BIT, 0, 3},
  ...
  {"sq2_tuning_row", CFGSER_INT, 9, 16},               /* total: 25 */
  ...
  {"locktest_pass_amplitude", CFGSER_INT, 69, 1},      /* total: 70 */
  {"sq1_ramp_bias_start", CFGSER_INT, 70, 1},          /* total: 71 */
  {"sq1_ramp_bias_step",  CFGSER_INT, 71, 1},          /* total: 72 */
  {"sq1_ramp_bias_count", CFGSER_INT, 72, 1},          /* total: 73 */
  ...
  {"sq1servo_safb_init", CFGSER_INT, 123, 16},         /* total: 139 */
  ...
  {"sa_flux_quantum", CFGSER_INT, 167, 16},            /* total: 183 */
  {"sq2_flux_quantum", CFGSER_INT, 183, 16},           /* total: 199 */
  {"flux_quanta_all", CFGSER_INT, 199, 528},           /* total: 727 */
  {"sq1_bias", CFGSER_INT, 727, 33},                   /* total: 760 */
  {"sq1_bias_off", CFGSER_INT, 727, 33},               /* total: 793 */
  {"sq2_bias", CFGSER_INT, 727, 16},                   /* total: 809 */
  {"sq2_fb", CFGSER_INT, 809, 528},                    /* total: 1337 */
  {"sa_bias", CFGSER_INT, 1337, 16},                   /* total: 1353 */
  {"sa_fb", CFGSER_INT, 1353, 16},                     /* total: 1369 */
  {"sa_offset", CFGSER_INT, 1353, 16},                 /* total: 1385 */
